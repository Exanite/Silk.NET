...
{
    /// <summary>Validates that the value of the <see cref = "IdxgiDevice3"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "IdxgiSwapChain2"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "IdxgiOutput2"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "IdxgiFactory3"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "IdxgiDecodeSwapChain"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "IdxgiFactoryMedia"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "IdxgiSwapChainMedia"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "IdxgiOutput3"/> property is correct.</summary>
