...
public static partial class D3DAUTHENTICATEDQUERYTests
{
    ...
    /// <summary>Validates that the value of the <see cref = "Channeltype"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "Devicehandle"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "Restrictedsharedresourceprocesscount"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "Restrictedsharedresourceprocess"/> property is correct.</summary>

    [Test]
    public static void D3DAUTHENTICATEDQUERY_RESTRICTEDSHAREDRESOURCEPROCESSTest()
    {
        Assert.That(
            Restrictedsharedresourceprocess,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "Unrestrictedprotectedsharedresourcecount"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "Outputidcount"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "Outputid"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "Accessibilityattributes"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "Encryptionwhenaccessibleguidcount"/> property is correct.</summary>

    [Test]
    public static void D3DAUTHENTICATEDQUERY_ENCRYPTIONWHENACCESSIBLEGUIDCOUNTTest()
    {
        Assert.That(
            Encryptionwhenaccessibleguidcount,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "Encryptionwhenaccessibleguid"/> property is correct.</summary>

    [Test]
    public static void D3DAUTHENTICATEDQUERY_ENCRYPTIONWHENACCESSIBLEGUIDTest()
    {
        Assert.That(
            Encryptionwhenaccessibleguid,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "Currentencryptionwhenaccessible"/> property is correct.</summary>

    [Test]
    public static void D3DAUTHENTICATEDQUERY_CURRENTENCRYPTIONWHENACCESSIBLETest()
    {
        Assert.That(
            Currentencryptionwhenaccessible,
            Is.EqualTo(
