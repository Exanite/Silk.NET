...
public static unsafe partial class ID3D12VideoDecodeCommandList3Tests
{
    ...
    {
        Assert.That(
            typeof(ID3D12VideoDecodeCommandList3).GUID,
            Is.EqualTo(IID.ID3D12VideoDecodeCommandList3)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12VideoDecodeCommandList3>(),
            Is.EqualTo(sizeof(ID3D12VideoDecodeCommandList3))
        );
    }
