...
public static unsafe partial class ID3D12VideoMotionVectorHeapTests
{
    ...
    {
        Assert.That(
            typeof(ID3D12VideoMotionVectorHeap).GUID,
            Is.EqualTo(IID.ID3D12VideoMotionVectorHeap)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12VideoMotionVectorHeap>(),
            Is.EqualTo(sizeof(ID3D12VideoMotionVectorHeap))
        );
    }
