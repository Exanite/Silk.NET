...
{
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileMpeg2"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_MPEG2Test()
    {
        Assert.That(
            VideoDecodeProfileMpeg2,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileMpeg1AndMpeg2"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_MPEG1_AND_MPEG2Test()
    {
        Assert.That(
            VideoDecodeProfileMpeg1AndMpeg2,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileH264"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_H264Test()
    {
        Assert.That(
            VideoDecodeProfileH264,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileH264StereoProgressive"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_H264_STEREO_PROGRESSIVETest()
    {
        Assert.That(
            VideoDecodeProfileH264StereoProgressive,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileH264Stereo"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_H264_STEREOTest()
    {
        Assert.That(
            VideoDecodeProfileH264Stereo,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileH264Multiview"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_H264_MULTIVIEWTest()
    {
        Assert.That(
            VideoDecodeProfileH264Multiview,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileVc1"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_VC1Test()
    {
        Assert.That(
            VideoDecodeProfileVc1,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileVc1D2010"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_VC1_D2010Test()
    {
        Assert.That(
            VideoDecodeProfileVc1D2010,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileMpeg4Pt2Simple"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_MPEG4PT2_SIMPLETest()
    {
        Assert.That(
            VideoDecodeProfileMpeg4Pt2Simple,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileMpeg4Pt2AdvsimpleNogmc"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_MPEG4PT2_ADVSIMPLE_NOGMCTest()
    {
        Assert.That(
            VideoDecodeProfileMpeg4Pt2AdvsimpleNogmc,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAINTest()
    {
        Assert.That(
            VideoDecodeProfileHevcMain,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain10"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN10Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMain10,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMonochrome"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MONOCHROMETest()
    {
        Assert.That(
            VideoDecodeProfileHevcMonochrome,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMonochrome10"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MONOCHROME10Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMonochrome10,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain12"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN12Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMain12,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain10X422"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN10_422Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMain10X422,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain12X422"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN12_422Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMain12X422,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain444"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN_444Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMain444,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain10Ext"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN10_EXTTest()
    {
        Assert.That(
            VideoDecodeProfileHevcMain10Ext,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain10X444"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN10_444Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMain10X444,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain12X444"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN12_444Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMain12X444,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileHevcMain16"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN16Test()
    {
        Assert.That(
            VideoDecodeProfileHevcMain16,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileVp9"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_VP9Test()
    {
        Assert.That(
            VideoDecodeProfileVp9,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileVp9X10BitProfile2"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_VP9_10BIT_PROFILE2Test()
    {
        Assert.That(
            VideoDecodeProfileVp9X10BitProfile2,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileVp8"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_VP8Test()
    {
        Assert.That(
            VideoDecodeProfileVp8,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileAv1Profile0"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_AV1_PROFILE0Test()
    {
        Assert.That(
            VideoDecodeProfileAv1Profile0,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileAv1Profile1"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_AV1_PROFILE1Test()
    {
        Assert.That(
            VideoDecodeProfileAv1Profile1,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileAv1Profile2"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_AV1_PROFILE2Test()
    {
        Assert.That(
            VideoDecodeProfileAv1Profile2,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileAv1X12BitProfile2"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_AV1_12BIT_PROFILE2Test()
    {
        Assert.That(
            VideoDecodeProfileAv1X12BitProfile2,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileAv1X12BitProfile2X420"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_AV1_12BIT_PROFILE2_420Test()
    {
        Assert.That(
            VideoDecodeProfileAv1X12BitProfile2X420,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileMjpegVld420"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_MJPEG_VLD_420Test()
    {
        Assert.That(
            VideoDecodeProfileMjpegVld420,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileMjpegVld422"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_MJPEG_VLD_422Test()
    {
        Assert.That(
            VideoDecodeProfileMjpegVld422,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileMjpegVld444"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_MJPEG_VLD_444Test()
    {
        Assert.That(
            VideoDecodeProfileMjpegVld444,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileMjpegVld4444"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_MJPEG_VLD_4444Test()
    {
        Assert.That(
            VideoDecodeProfileMjpegVld4444,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileJpegVld420"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_JPEG_VLD_420Test()
    {
        Assert.That(
            VideoDecodeProfileJpegVld420,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileJpegVld422"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_JPEG_VLD_422Test()
    {
        Assert.That(
            VideoDecodeProfileJpegVld422,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "VideoDecodeProfileJpegVld444"/> property is correct.</summary>

    [Test]
    public static void D3D12_VIDEO_DECODE_PROFILE_JPEG_VLD_444Test()
    {
        Assert.That(
            VideoDecodeProfileJpegVld444,
            Is.EqualTo(
