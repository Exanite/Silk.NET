...
public static unsafe partial class ID3D12VideoEncodeCommandListTests
{
    ...
    {
        Assert.That(
            typeof(ID3D12VideoEncodeCommandList).GUID,
            Is.EqualTo(IID.ID3D12VideoEncodeCommandList)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12VideoEncodeCommandList>(),
            Is.EqualTo(sizeof(ID3D12VideoEncodeCommandList))
        );
    }
