...
public static unsafe partial class ID3D12VideoDecodeCommandList2Tests
{
    ...
    {
        Assert.That(
            typeof(ID3D12VideoDecodeCommandList2).GUID,
            Is.EqualTo(IID.ID3D12VideoDecodeCommandList2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12VideoDecodeCommandList2>(),
            Is.EqualTo(sizeof(ID3D12VideoDecodeCommandList2))
        );
    }
