...
{
    /// <summary>Validates that the value of the <see cref = "ID3D12ShaderReflectionType"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "ID3D12ShaderReflectionVariable"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "ID3D12ShaderReflectionConstantBuffer"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "ID3D12ShaderReflection"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "ID3D12LibraryReflection"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "ID3D12FunctionReflection"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "ID3D12FunctionParameterReflection"/> property is correct.</summary>
