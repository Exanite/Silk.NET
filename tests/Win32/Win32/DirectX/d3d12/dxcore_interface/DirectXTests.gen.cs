...
{
    /// <summary>Validates that the value of the <see cref = "DxcoreAdapterAttributeD3D11Graphics"/> property is correct.</summary>

    [Test]
    public static void DXCORE_ADAPTER_ATTRIBUTE_D3D11_GRAPHICSTest()
    {
        Assert.That(
            DxcoreAdapterAttributeD3D11Graphics,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "DxcoreAdapterAttributeD3D12Graphics"/> property is correct.</summary>

    [Test]
    public static void DXCORE_ADAPTER_ATTRIBUTE_D3D12_GRAPHICSTest()
    {
        Assert.That(
            DxcoreAdapterAttributeD3D12Graphics,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "DxcoreAdapterAttributeD3D12CoreCompute"/> property is correct.</summary>

    [Test]
    public static void DXCORE_ADAPTER_ATTRIBUTE_D3D12_CORE_COMPUTETest()
    {
        Assert.That(
            DxcoreAdapterAttributeD3D12CoreCompute,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "DxcoreAdapterAttributeD3D12GenericMl"/> property is correct.</summary>

    [Test]
    public static void DXCORE_ADAPTER_ATTRIBUTE_D3D12_GENERIC_MLTest()
    {
        Assert.That(
            DxcoreAdapterAttributeD3D12GenericMl,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "DxcoreAdapterAttributeD3D12GenericMedia"/> property is correct.</summary>

    [Test]
    public static void DXCORE_ADAPTER_ATTRIBUTE_D3D12_GENERIC_MEDIATest()
    {
        Assert.That(
            DxcoreAdapterAttributeD3D12GenericMedia,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "DxcoreHardwareTypeAttributeGpu"/> property is correct.</summary>

    [Test]
    public static void DXCORE_HARDWARE_TYPE_ATTRIBUTE_GPUTest()
    {
        Assert.That(
            DxcoreHardwareTypeAttributeGpu,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "DxcoreHardwareTypeAttributeComputeAccelerator"/> property is correct.</summary>

    [Test]
    public static void DXCORE_HARDWARE_TYPE_ATTRIBUTE_COMPUTE_ACCELERATORTest()
    {
        Assert.That(
            DxcoreHardwareTypeAttributeComputeAccelerator,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "DxcoreHardwareTypeAttributeNpu"/> property is correct.</summary>

    [Test]
    public static void DXCORE_HARDWARE_TYPE_ATTRIBUTE_NPUTest()
    {
        Assert.That(
            DxcoreHardwareTypeAttributeNpu,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "DxcoreHardwareTypeAttributeMediaAccelerator"/> property is correct.</summary>

    [Test]
    public static void DXCORE_HARDWARE_TYPE_ATTRIBUTE_MEDIA_ACCELERATORTest()
    {
        Assert.That(
            DxcoreHardwareTypeAttributeMediaAccelerator,
            Is.EqualTo(
