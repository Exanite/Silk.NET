...
using static Silk.NET.Win32.Clsid;
...
{
    /// <summary>Validates that the value of the <see cref = "D3D12Debug"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "D3D12Tools"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "D3D12DeviceRemovedExtendedData"/> property is correct.</summary>
    ...
    /// <summary>Validates that the value of the <see cref = "D3D12SDKConfiguration"/> property is correct.</summary>

    [Test]
    public static void CLSID_D3D12SDKConfigurationTest()
    {
        Assert.That(
            D3D12SDKConfiguration,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "D3D12DeviceFactory"/> property is correct.</summary>
