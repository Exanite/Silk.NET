...
public static unsafe partial class ID3D12LifetimeTrackerTests
{
    ...
    {
        Assert.That(typeof(ID3D12LifetimeTracker).GUID, Is.EqualTo(IID.ID3D12LifetimeTracker));
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12LifetimeTracker>(),
            Is.EqualTo(sizeof(ID3D12LifetimeTracker))
        );
    }
