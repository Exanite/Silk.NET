...
public unsafe partial struct IInspectable : IInspectable.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IInspectable));
    ...
    public interface Interface : IUnknown.Interface
    {
        ...
        HResult GetIids([NativeTypeName("ULONG *")] Ref<uint> iidCount, [NativeTypeName("IID **")] Ref2D<Guid> iids);
        [VtblIndex(4)]
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IInspectable.Native*, uint> )(lpVtbl[1]))((IInspectable.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IInspectable.Native*, uint*, Guid**, int> )(lpVtbl[3]))((IInspectable.Native*)Unsafe.AsPointer(ref this), iidCount, iids);
        }

        [VtblIndex(3)]
        [Transformed]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        public HResult GetIids([NativeTypeName("ULONG *")] Ref<uint> iidCount, [NativeTypeName("IID **")] Ref2D<Guid> iids)
        {
        ...
        {
            return ((delegate* unmanaged<IInspectable.Native*, HString*, int> )(lpVtbl[4]))((IInspectable.Native*)Unsafe.AsPointer(ref this), className);
        }
        ...
        {
            return ((delegate* unmanaged<IInspectable.Native*, TrustLevel*, int> )(lpVtbl[5]))((IInspectable.Native*)Unsafe.AsPointer(ref this), trustLevel);
        }
        ...
        {
            return ((delegate* unmanaged<IInspectable.Native*, Guid*, void**, int> )(lpVtbl[0]))((IInspectable.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IInspectable.Native*, uint> )(lpVtbl[2]))((IInspectable.Native*)Unsafe.AsPointer(ref this));
        }
    }
    ...
    public static implicit operator IInspectable(IInspectable.Native* value) => new IInspectable((Ptr<Native>)value);
    ...
    public static explicit operator IInspectable(Ptr<IInspectable.Native> value) => new IInspectable(value);
    /// <summary>casts <see cref = "IInspectable"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "IInspectable"/> instance to be converted </param>
    public static implicit operator Ptr<IInspectable.Native>(IInspectable value) => (Ptr<IInspectable.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "IInspectable"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator IInspectable(void*** value) => new IInspectable((Ptr<Native>)value);
    ...
    public static explicit operator IInspectable(nuint value) => new IInspectable((Ptr<Native>)value.ToPointer());
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(3)]
    public HResult GetIids([NativeTypeName("ULONG *")] uint* iidCount, [NativeTypeName("IID **")] Guid** iids) => LpVtbl->GetIids(iidCount, iids);
    [VtblIndex(3)]
    [Transformed]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public HResult GetIids([NativeTypeName("ULONG *")] Ref<uint> iidCount, [NativeTypeName("IID **")] Ref2D<Guid> iids)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(4)]
    public HResult GetRuntimeClassName(HString* className) => LpVtbl->GetRuntimeClassName(className);
    [VtblIndex(4)]
    [Transformed]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public HResult GetRuntimeClassName(Ref<HString> className)
