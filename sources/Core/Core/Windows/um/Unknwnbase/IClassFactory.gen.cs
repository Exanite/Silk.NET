...
public unsafe partial struct IClassFactory : IClassFactory.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IClassFactory));
    ...
    public interface Interface : IUnknown.Interface
    {
        ...
        HResult CreateInstance(IUnknown pUnkOuter, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppvObject);
        [VtblIndex(4)]
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IClassFactory.Native*, uint> )(lpVtbl[1]))((IClassFactory.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IClassFactory.Native*, IUnknown.Native*, Guid*, void**, int> )(lpVtbl[3]))((IClassFactory.Native*)Unsafe.AsPointer(ref this), pUnkOuter.LpVtbl, riid, ppvObject);
        }

        [VtblIndex(3)]
        [Transformed]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        public HResult CreateInstance(IUnknown pUnkOuter, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppvObject)
        {
        ...
        {
            return ((delegate* unmanaged<IClassFactory.Native*, MaybeBool<int>, int> )(lpVtbl[4]))((IClassFactory.Native*)Unsafe.AsPointer(ref this), fLock);
        }
        ...
        {
            return ((delegate* unmanaged<IClassFactory.Native*, Guid*, void**, int> )(lpVtbl[0]))((IClassFactory.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IClassFactory.Native*, uint> )(lpVtbl[2]))((IClassFactory.Native*)Unsafe.AsPointer(ref this));
        }
    }
    ...
    public static implicit operator IClassFactory(IClassFactory.Native* value) => new IClassFactory((Ptr<Native>)value);
    ...
    public static explicit operator IClassFactory(Ptr<IClassFactory.Native> value) => new IClassFactory(value);
    /// <summary>casts <see cref = "IClassFactory"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "IClassFactory"/> instance to be converted </param>
    public static implicit operator Ptr<IClassFactory.Native>(IClassFactory value) => (Ptr<IClassFactory.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "IClassFactory"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator IClassFactory(void*** value) => new IClassFactory((Ptr<Native>)value);
    ...
    public static explicit operator IClassFactory(nuint value) => new IClassFactory((Ptr<Native>)value.ToPointer());
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(3)]
    public HResult CreateInstance(IUnknown pUnkOuter, [NativeTypeName("const IID &")] Guid* riid, void** ppvObject) => LpVtbl->CreateInstance(pUnkOuter, riid, ppvObject);
    [VtblIndex(3)]
    [Transformed]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public HResult CreateInstance(IUnknown pUnkOuter, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppvObject)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(4)]
    public HResult LockServer([NativeTypeName("BOOL")] MaybeBool<int> fLock) => LpVtbl->LockServer(fLock);
    /// <inheritdoc cref = "IUnknown.QueryInterface"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(0)]
