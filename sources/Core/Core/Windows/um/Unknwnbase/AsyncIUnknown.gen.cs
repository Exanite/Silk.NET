...
public unsafe partial struct AsyncIUnknown : AsyncIUnknown.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.AsyncIUnknown));
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, uint> )(lpVtbl[1]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, int> )(lpVtbl[5]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, Guid*, int> )(lpVtbl[3]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this), riid);
        }
        ...
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, int> )(lpVtbl[7]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, uint> )(lpVtbl[6]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, void**, int> )(lpVtbl[4]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this), ppvObject);
        }
        ...
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, uint> )(lpVtbl[8]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, Guid*, void**, int> )(lpVtbl[0]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<AsyncIUnknown.Native*, uint> )(lpVtbl[2]))((AsyncIUnknown.Native*)Unsafe.AsPointer(ref this));
        }
    }
    ...
    public static implicit operator AsyncIUnknown(AsyncIUnknown.Native* value) => new AsyncIUnknown((Ptr<Native>)value);
    ...
    public static explicit operator AsyncIUnknown(Ptr<AsyncIUnknown.Native> value) => new AsyncIUnknown(value);
    /// <summary>casts <see cref = "AsyncIUnknown"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "AsyncIUnknown"/> instance to be converted </param>
    public static implicit operator Ptr<AsyncIUnknown.Native>(AsyncIUnknown value) => (Ptr<AsyncIUnknown.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "AsyncIUnknown"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator AsyncIUnknown(void*** value) => new AsyncIUnknown((Ptr<Native>)value);
    ...
    public static explicit operator AsyncIUnknown(nuint value) => new AsyncIUnknown((Ptr<Native>)value.ToPointer());
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(3)]
    public HResult Begin_QueryInterface([NativeTypeName("const IID &")] Guid* riid) => LpVtbl->Begin_QueryInterface(riid);
    [VtblIndex(3)]
    [Transformed]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public HResult Begin_QueryInterface([NativeTypeName("const IID &")] Ref<Guid> riid)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(4)]
    public HResult Finish_QueryInterface(void** ppvObject) => LpVtbl->Finish_QueryInterface(ppvObject);
    [VtblIndex(4)]
    [Transformed]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public HResult Finish_QueryInterface(Ref2D ppvObject)
