...
public unsafe partial struct IUnknown : IUnknown.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IUnknown));
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IUnknown.Native*, uint> )(lpVtbl[1]))((IUnknown.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IUnknown.Native*, Guid*, void**, int> )(lpVtbl[0]))((IUnknown.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IUnknown.Native*, uint> )(lpVtbl[2]))((IUnknown.Native*)Unsafe.AsPointer(ref this));
        }
    }
    ...
    public static implicit operator IUnknown(IUnknown.Native* value) => new IUnknown((Ptr<Native>)value);
    ...
    /// <param name = "value">The <see cref = "IUnknown"/> instance to be converted </param>
    public static implicit operator Ptr<IUnknown.Native>(IUnknown value) => (Ptr<IUnknown.Native>)value.LpVtbl;
    ...
    public static explicit operator IUnknown(nuint value) => new IUnknown((Ptr<Native>)value.ToPointer());
