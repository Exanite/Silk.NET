...
public static partial class WinRT
{
    ...
    public static unsafe PDF_RENDER_PARAMS PdfRenderParams(
        [NativeTypeName("const D2D_RECT_F &")] D2DRectF* srcRect,
        [NativeTypeName("UINT32")] uint destinationWidth,
        [NativeTypeName("UINT32")] uint destinationHeight,
        [NativeTypeName("const D2D_COLOR_F &")] DxgiRgba* bkColor,
    ...
    public static unsafe PDF_RENDER_PARAMS PdfRenderParams(
        [NativeTypeName("const D2D_RECT_F &")] Ref<D2DRectF> srcRect,
        [NativeTypeName("UINT32")] uint destinationWidth,
        [NativeTypeName("UINT32")] uint destinationHeight,
        [NativeTypeName("const D2D_COLOR_F &")] Ref<DxgiRgba> bkColor,
        [NativeTypeName("BOOLEAN")] byte ignoreHighContrast
    )
    {
        fixed (DxgiRgba* __dsl_bkColor = bkColor)
        fixed (D2DRectF* __dsl_srcRect = srcRect)
        {
