...
public static partial class DirectX
{
    ...
    public const int CompositionobjectRead = 0x0001;

    [NativeTypeName("#define COMPOSITIONOBJECT_WRITE 0x0002L")]
    public const int CompositionobjectWrite = 0x0002;

    [NativeTypeName(
        "#define COMPOSITIONOBJECT_ALL_ACCESS (COMPOSITIONOBJECT_READ | COMPOSITIONOBJECT_WRITE)"
    )]
    public const int CompositionobjectAllAccess = (0x0001 | 0x0002);

    [NativeTypeName("#define COMPOSITION_STATS_MAX_TARGETS 256")]
    public const int CompositionStatsMaxTargets = 256;
}
