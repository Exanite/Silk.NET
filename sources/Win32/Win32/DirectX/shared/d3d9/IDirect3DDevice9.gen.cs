...
public unsafe partial struct IDirect3DDevice9 : IDirect3DDevice9.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IDirect3DDevice9));
    ...
    public interface Interface : IUnknown.Interface
    {
        ...
        HResult Clear([NativeTypeName("DWORD")] uint Count, [NativeTypeName("const D3DRECT *")] Ref<D3Drect> pRects, [NativeTypeName("DWORD")] uint Flags, [NativeTypeName("D3DCOLOR")] uint Color, float Z, [NativeTypeName("DWORD")] uint Stencil);
        [VtblIndex(35)]
        HResult ColorFill(IDirect3DSurface9 pSurface, [NativeTypeName("const RECT *")] RECT* pRect, [NativeTypeName("D3DCOLOR")] uint color);
        [VtblIndex(35)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult ColorFill(IDirect3DSurface9 pSurface, [NativeTypeName("const RECT *")] Ref<RECT> pRect, [NativeTypeName("D3DCOLOR")] uint color);
        [VtblIndex(13)]
        HResult CreateAdditionalSwapChain(D3DpresentParameters* pPresentationParameters, IDirect3DSwapChain9* pSwapChain);
        [VtblIndex(13)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateAdditionalSwapChain(Ref<D3DpresentParameters> pPresentationParameters, Ref<IDirect3DSwapChain9> pSwapChain);
        [VtblIndex(25)]
        ...
        [VtblIndex(25)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateCubeTexture(uint EdgeLength, uint Levels, [NativeTypeName("DWORD")] uint Usage, D3Dformat Format, D3Dpool Pool, Ref<IDirect3DCubeTexture9> ppCubeTexture, Ref<Handle> pSharedHandle);
        [VtblIndex(29)]
        HResult CreateDepthStencilSurface(uint Width, uint Height, D3Dformat Format, D3DmultisampleType MultiSample, [NativeTypeName("DWORD")] uint MultisampleQuality, [NativeTypeName("BOOL")] MaybeBool<int> Discard, IDirect3DSurface9* ppSurface, Handle* pSharedHandle);
        [VtblIndex(29)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateDepthStencilSurface(uint Width, uint Height, D3Dformat Format, D3DmultisampleType MultiSample, [NativeTypeName("DWORD")] uint MultisampleQuality, [NativeTypeName("BOOL")] MaybeBool<int> Discard, Ref<IDirect3DSurface9> ppSurface, Ref<Handle> pSharedHandle);
        [VtblIndex(27)]
        ...
        [VtblIndex(27)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateIndexBuffer(uint Length, [NativeTypeName("DWORD")] uint Usage, D3Dformat Format, D3Dpool Pool, Ref<IDirect3DIndexBuffer9> ppIndexBuffer, Ref<Handle> pSharedHandle);
        [VtblIndex(36)]
        ...
        [VtblIndex(36)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateOffscreenPlainSurface(uint Width, uint Height, D3Dformat Format, D3Dpool Pool, Ref<IDirect3DSurface9> ppSurface, Ref<Handle> pSharedHandle);
        [VtblIndex(106)]
        HResult CreatePixelShader([NativeTypeName("const DWORD *")] uint* pFunction, IDirect3DPixelShader9* ppShader);
        [VtblIndex(106)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreatePixelShader([NativeTypeName("const DWORD *")] Ref<uint> pFunction, Ref<IDirect3DPixelShader9> ppShader);
        [VtblIndex(118)]
        HResult CreateQuery(D3Dquerytype Type, IDirect3DQuery9* ppQuery);
        [VtblIndex(118)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateQuery(D3Dquerytype Type, Ref<IDirect3DQuery9> ppQuery);
        [VtblIndex(28)]
        HResult CreateRenderTarget(uint Width, uint Height, D3Dformat Format, D3DmultisampleType MultiSample, [NativeTypeName("DWORD")] uint MultisampleQuality, [NativeTypeName("BOOL")] MaybeBool<int> Lockable, IDirect3DSurface9* ppSurface, Handle* pSharedHandle);
        [VtblIndex(28)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateRenderTarget(uint Width, uint Height, D3Dformat Format, D3DmultisampleType MultiSample, [NativeTypeName("DWORD")] uint MultisampleQuality, [NativeTypeName("BOOL")] MaybeBool<int> Lockable, Ref<IDirect3DSurface9> ppSurface, Ref<Handle> pSharedHandle);
        [VtblIndex(59)]
        HResult CreateStateBlock(D3Dstateblocktype Type, IDirect3DStateBlock9* ppSB);
        [VtblIndex(59)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateStateBlock(D3Dstateblocktype Type, Ref<IDirect3DStateBlock9> ppSB);
        [VtblIndex(23)]
        ...
        [VtblIndex(23)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateTexture(uint Width, uint Height, uint Levels, [NativeTypeName("DWORD")] uint Usage, D3Dformat Format, D3Dpool Pool, Ref<IDirect3DTexture9> ppTexture, Ref<Handle> pSharedHandle);
        [VtblIndex(26)]
        ...
        [VtblIndex(26)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateVertexBuffer(uint Length, [NativeTypeName("DWORD")] uint Usage, [NativeTypeName("DWORD")] uint FVF, D3Dpool Pool, Ref<IDirect3DVertexBuffer9> ppVertexBuffer, Ref<Handle> pSharedHandle);
        [VtblIndex(86)]
        ...
        [VtblIndex(86)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateVertexDeclaration([NativeTypeName("const D3DVERTEXELEMENT9 *")] Ref<D3Dvertexelement9> pVertexElements, Ref<IDirect3DVertexDeclaration9> ppDecl);
        [VtblIndex(91)]
        HResult CreateVertexShader([NativeTypeName("const DWORD *")] uint* pFunction, IDirect3DVertexShader9* ppShader);
        [VtblIndex(91)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateVertexShader([NativeTypeName("const DWORD *")] Ref<uint> pFunction, Ref<IDirect3DVertexShader9> ppShader);
        [VtblIndex(24)]
        ...
        [VtblIndex(24)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateVolumeTexture(uint Width, uint Height, uint Depth, uint Levels, [NativeTypeName("DWORD")] uint Usage, D3Dformat Format, D3Dpool Pool, Ref<IDirect3DVolumeTexture9> ppVolumeTexture, Ref<Handle> pSharedHandle);
        [VtblIndex(117)]
        ...
        [VtblIndex(84)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult DrawIndexedPrimitiveUP(D3Dprimitivetype PrimitiveType, uint MinVertexIndex, uint NumVertices, uint PrimitiveCount, [NativeTypeName("const void *")] Ref pIndexData, D3Dformat IndexDataFormat, [NativeTypeName("const void *")] Ref pVertexStreamZeroData, uint VertexStreamZeroStride);
        [VtblIndex(81)]
        ...
        [VtblIndex(83)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult DrawPrimitiveUP(D3Dprimitivetype PrimitiveType, uint PrimitiveCount, [NativeTypeName("const void *")] Ref pVertexStreamZeroData, uint VertexStreamZeroStride);
        [VtblIndex(115)]
        HResult DrawRectPatch(uint Handle, [NativeTypeName("const float *")] float* pNumSegs, [NativeTypeName("const D3DRECTPATCH_INFO *")] D3DrectpatchInfo* pRectPatchInfo);
        [VtblIndex(115)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult DrawRectPatch(uint Handle, [NativeTypeName("const float *")] Ref<float> pNumSegs, [NativeTypeName("const D3DRECTPATCH_INFO *")] Ref<D3DrectpatchInfo> pRectPatchInfo);
        [VtblIndex(116)]
        HResult DrawTriPatch(uint Handle, [NativeTypeName("const float *")] float* pNumSegs, [NativeTypeName("const D3DTRIPATCH_INFO *")] D3DtripatchInfo* pTriPatchInfo);
        [VtblIndex(116)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult DrawTriPatch(uint Handle, [NativeTypeName("const float *")] Ref<float> pNumSegs, [NativeTypeName("const D3DTRIPATCH_INFO *")] Ref<D3DtripatchInfo> pTriPatchInfo);
        [VtblIndex(42)]
        HResult EndScene();
        [VtblIndex(61)]
        ...
        [VtblIndex(18)]
        HResult GetBackBuffer(uint iSwapChain, uint iBackBuffer, D3DbackbufferType Type, IDirect3DSurface9* ppBackBuffer);
        [VtblIndex(18)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetBackBuffer(uint iSwapChain, uint iBackBuffer, D3DbackbufferType Type, Ref<IDirect3DSurface9> ppBackBuffer);
        [VtblIndex(56)]
        HResult GetClipPlane([NativeTypeName("DWORD")] uint Index, float* pPlane);
        [VtblIndex(56)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetClipPlane([NativeTypeName("DWORD")] uint Index, Ref<float> pPlane);
        [VtblIndex(63)]
        ...
        [VtblIndex(9)]
        HResult GetCreationParameters(D3DdeviceCreationParameters* pParameters);
        [VtblIndex(9)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetCreationParameters(Ref<D3DdeviceCreationParameters> pParameters);
        [VtblIndex(74)]
        ...
        [VtblIndex(90)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetFVF([NativeTypeName("DWORD *")] Ref<uint> pFVF);
        [VtblIndex(22)]
        ...
        [VtblIndex(52)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetLight([NativeTypeName("DWORD")] uint Index, Ref<D3Dlight9> param1);
        [VtblIndex(54)]
        HResult GetLightEnable([NativeTypeName("DWORD")] uint Index, [NativeTypeName("BOOL *")] MaybeBool<int>* pEnable);
        [VtblIndex(54)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetLightEnable([NativeTypeName("DWORD")] uint Index, [NativeTypeName("BOOL *")] Ref<MaybeBool<int>> pEnable);
        [VtblIndex(50)]
        ...
        [VtblIndex(114)]
        HResult GetPixelShaderConstantB(uint StartRegister, [NativeTypeName("BOOL *")] MaybeBool<int>* pConstantData, uint BoolCount);
        [VtblIndex(114)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetPixelShaderConstantB(uint StartRegister, [NativeTypeName("BOOL *")] Ref<MaybeBool<int>> pConstantData, uint BoolCount);
        [VtblIndex(110)]
        ...
        [VtblIndex(19)]
        HResult GetRasterStatus(uint iSwapChain, D3DrasterStatus* pRasterStatus);
        [VtblIndex(19)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetRasterStatus(uint iSwapChain, Ref<D3DrasterStatus> pRasterStatus);
        [VtblIndex(58)]
        HResult GetRenderState(D3Drenderstatetype State, [NativeTypeName("DWORD *")] uint* pValue);
        [VtblIndex(58)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetRenderState(D3Drenderstatetype State, [NativeTypeName("DWORD *")] Ref<uint> pValue);
        [VtblIndex(38)]
        HResult GetRenderTarget([NativeTypeName("DWORD")] uint RenderTargetIndex, IDirect3DSurface9* ppRenderTarget);
        [VtblIndex(38)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetRenderTarget([NativeTypeName("DWORD")] uint RenderTargetIndex, Ref<IDirect3DSurface9> ppRenderTarget);
        [VtblIndex(32)]
        ...
        [VtblIndex(68)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetSamplerState([NativeTypeName("DWORD")] uint Sampler, D3Dsamplerstatetype Type, [NativeTypeName("DWORD *")] Ref<uint> pValue);
        [VtblIndex(76)]
        ...
        MaybeBool<int> GetSoftwareVertexProcessing();
        [VtblIndex(101)]
        ...
        [VtblIndex(64)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetTexture([NativeTypeName("DWORD")] uint Stage, Ref<IDirect3DBaseTexture9> ppTexture);
        [VtblIndex(66)]
        ...
        [VtblIndex(66)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetTextureStageState([NativeTypeName("DWORD")] uint Stage, D3Dtexturestagestatetype Type, [NativeTypeName("DWORD *")] Ref<uint> pValue);
        [VtblIndex(45)]
        HResult GetTransform(D3Dtransformstatetype State, [NativeTypeName("D3DMATRIX *")] D2DMatrix4X4F* pMatrix);
        [VtblIndex(45)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetTransform(D3Dtransformstatetype State, [NativeTypeName("D3DMATRIX *")] Ref<D2DMatrix4X4F> pMatrix);
        [VtblIndex(88)]
        ...
        [VtblIndex(99)]
        HResult GetVertexShaderConstantB(uint StartRegister, [NativeTypeName("BOOL *")] MaybeBool<int>* pConstantData, uint BoolCount);
        [VtblIndex(99)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult GetVertexShaderConstantB(uint StartRegister, [NativeTypeName("BOOL *")] Ref<MaybeBool<int>> pConstantData, uint BoolCount);
        [VtblIndex(95)]
        ...
        [VtblIndex(53)]
        HResult LightEnable([NativeTypeName("DWORD")] uint Index, [NativeTypeName("BOOL")] MaybeBool<int> Enable);
        [VtblIndex(46)]
        HResult MultiplyTransform(D3Dtransformstatetype param0, [NativeTypeName("const D3DMATRIX *")] D2DMatrix4X4F* param1);
        [VtblIndex(46)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult MultiplyTransform(D3Dtransformstatetype param0, [NativeTypeName("const D3DMATRIX *")] Ref<D2DMatrix4X4F> param1);
        [VtblIndex(17)]
        ...
        [VtblIndex(17)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult Present([NativeTypeName("const RECT *")] Ref<RECT> pSourceRect, [NativeTypeName("const RECT *")] Ref<RECT> pDestRect, HWND hDestWindowOverride, [NativeTypeName("const RGNDATA *")] Ref<RGNDATA> pDirtyRegion);
        [VtblIndex(85)]
        ...
        [VtblIndex(16)]
        HResult Reset(D3DpresentParameters* pPresentationParameters);
        [VtblIndex(16)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult Reset(Ref<D3DpresentParameters> pPresentationParameters);
        [VtblIndex(55)]
        HResult SetClipPlane([NativeTypeName("DWORD")] uint Index, [NativeTypeName("const float *")] float* pPlane);
        [VtblIndex(55)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetClipPlane([NativeTypeName("DWORD")] uint Index, [NativeTypeName("const float *")] Ref<float> pPlane);
        [VtblIndex(62)]
        HResult SetClipStatus([NativeTypeName("const D3DCLIPSTATUS9 *")] D3Dclipstatus9* pClipStatus);
        [VtblIndex(62)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetClipStatus([NativeTypeName("const D3DCLIPSTATUS9 *")] Ref<D3Dclipstatus9> pClipStatus);
        [VtblIndex(73)]
        ...
        [VtblIndex(20)]
        HResult SetDialogBoxMode([NativeTypeName("BOOL")] MaybeBool<int> bEnableDialogs);
        [VtblIndex(89)]
        ...
        [VtblIndex(21)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        void SetGammaRamp(uint iSwapChain, [NativeTypeName("DWORD")] uint Flags, [NativeTypeName("const D3DGAMMARAMP *")] Ref<D3Dgammaramp> pRamp);
        [VtblIndex(104)]
        ...
        [VtblIndex(51)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetLight([NativeTypeName("DWORD")] uint Index, [NativeTypeName("const D3DLIGHT9 *")] Ref<D3Dlight9> param1);
        [VtblIndex(49)]
        HResult SetMaterial([NativeTypeName("const D3DMATERIAL9 *")] D3Dmaterial9* pMaterial);
        [VtblIndex(49)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetMaterial([NativeTypeName("const D3DMATERIAL9 *")] Ref<D3Dmaterial9> pMaterial);
        [VtblIndex(79)]
        ...
        [VtblIndex(71)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetPaletteEntries(uint PaletteNumber, [NativeTypeName("const PALETTEENTRY *")] Ref<PALETTEENTRY> pEntries);
        [VtblIndex(107)]
        HResult SetPixelShader(IDirect3DPixelShader9 pShader);
        [VtblIndex(113)]
        HResult SetPixelShaderConstantB(uint StartRegister, [NativeTypeName("const BOOL *")] MaybeBool<int>* pConstantData, uint BoolCount);
        [VtblIndex(113)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetPixelShaderConstantB(uint StartRegister, [NativeTypeName("const BOOL *")] Ref<MaybeBool<int>> pConstantData, uint BoolCount);
        [VtblIndex(109)]
        HResult SetPixelShaderConstantF(uint StartRegister, [NativeTypeName("const float *")] float* pConstantData, uint Vector4fCount);
        [VtblIndex(109)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetPixelShaderConstantF(uint StartRegister, [NativeTypeName("const float *")] Ref<float> pConstantData, uint Vector4fCount);
        [VtblIndex(111)]
        HResult SetPixelShaderConstantI(uint StartRegister, [NativeTypeName("const int *")] int* pConstantData, uint Vector4iCount);
        [VtblIndex(111)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetPixelShaderConstantI(uint StartRegister, [NativeTypeName("const int *")] Ref<int> pConstantData, uint Vector4iCount);
        [VtblIndex(57)]
        ...
        [VtblIndex(75)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetScissorRect([NativeTypeName("const RECT *")] Ref<RECT> pRect);
        [VtblIndex(77)]
        HResult SetSoftwareVertexProcessing([NativeTypeName("BOOL")] MaybeBool<int> bSoftware);
        [VtblIndex(100)]
        ...
        [VtblIndex(44)]
        HResult SetTransform(D3Dtransformstatetype State, [NativeTypeName("const D3DMATRIX *")] D2DMatrix4X4F* pMatrix);
        [VtblIndex(44)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetTransform(D3Dtransformstatetype State, [NativeTypeName("const D3DMATRIX *")] Ref<D2DMatrix4X4F> pMatrix);
        [VtblIndex(87)]
        HResult SetVertexDeclaration(IDirect3DVertexDeclaration9 pDecl);
        [VtblIndex(92)]
        HResult SetVertexShader(IDirect3DVertexShader9 pShader);
        [VtblIndex(98)]
        HResult SetVertexShaderConstantB(uint StartRegister, [NativeTypeName("const BOOL *")] MaybeBool<int>* pConstantData, uint BoolCount);
        [VtblIndex(98)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetVertexShaderConstantB(uint StartRegister, [NativeTypeName("const BOOL *")] Ref<MaybeBool<int>> pConstantData, uint BoolCount);
        [VtblIndex(94)]
        HResult SetVertexShaderConstantF(uint StartRegister, [NativeTypeName("const float *")] float* pConstantData, uint Vector4fCount);
        [VtblIndex(94)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetVertexShaderConstantF(uint StartRegister, [NativeTypeName("const float *")] Ref<float> pConstantData, uint Vector4fCount);
        [VtblIndex(96)]
        HResult SetVertexShaderConstantI(uint StartRegister, [NativeTypeName("const int *")] int* pConstantData, uint Vector4iCount);
        [VtblIndex(96)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetVertexShaderConstantI(uint StartRegister, [NativeTypeName("const int *")] Ref<int> pConstantData, uint Vector4iCount);
        [VtblIndex(47)]
        HResult SetViewport([NativeTypeName("const D3DVIEWPORT9 *")] D3Dviewport9* pViewport);
        [VtblIndex(47)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult SetViewport([NativeTypeName("const D3DVIEWPORT9 *")] Ref<D3Dviewport9> pViewport);
        [VtblIndex(12)]
        [return: NativeTypeName("BOOL")]
        MaybeBool<int> ShowCursor([NativeTypeName("BOOL")] MaybeBool<int> bShow);
        [VtblIndex(34)]
        ...
        [VtblIndex(34)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult StretchRect(IDirect3DSurface9 pSourceSurface, [NativeTypeName("const RECT *")] Ref<RECT> pSourceRect, IDirect3DSurface9 pDestSurface, [NativeTypeName("const RECT *")] Ref<RECT> pDestRect, D3Dtexturefiltertype Filter);
        [VtblIndex(3)]
        ...
        [VtblIndex(30)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult UpdateSurface(IDirect3DSurface9 pSourceSurface, [NativeTypeName("const RECT *")] Ref<RECT> pSourceRect, IDirect3DSurface9 pDestinationSurface, [NativeTypeName("const POINT *")] Ref<Point> pDestPoint);
        [VtblIndex(31)]
        ...
        [VtblIndex(70)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult ValidateDevice([NativeTypeName("DWORD *")] Ref<uint> pNumPasses);
    }
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint> )(lpVtbl[1]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, HResult> )(lpVtbl[41]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, HResult> )(lpVtbl[60]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Drect*, uint, uint, float, uint, HResult> )(lpVtbl[43]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Count, pRects, Flags, Color, Z, Stencil);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DSurface9.Native*, RECT*, uint, HResult> )(lpVtbl[35]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pSurface.LpVtbl, pRect, color);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3DpresentParameters*, IDirect3DSwapChain9.Native**, HResult> )(lpVtbl[13]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pPresentationParameters, &pSwapChain->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, uint, D3Dformat, D3Dpool, IDirect3DCubeTexture9.Native**, Handle*, HResult> )(lpVtbl[25]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), EdgeLength, Levels, Usage, Format, Pool, &ppCubeTexture->LpVtbl, pSharedHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, D3Dformat, D3DmultisampleType, uint, MaybeBool<int>, IDirect3DSurface9.Native**, Handle*, HResult> )(lpVtbl[29]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Width, Height, Format, MultiSample, MultisampleQuality, Discard, &ppSurface->LpVtbl, pSharedHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, D3Dformat, D3Dpool, IDirect3DIndexBuffer9.Native**, Handle*, HResult> )(lpVtbl[27]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Length, Usage, Format, Pool, &ppIndexBuffer->LpVtbl, pSharedHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, D3Dformat, D3Dpool, IDirect3DSurface9.Native**, Handle*, HResult> )(lpVtbl[36]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Width, Height, Format, Pool, &ppSurface->LpVtbl, pSharedHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint*, IDirect3DPixelShader9.Native**, HResult> )(lpVtbl[106]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pFunction, &ppShader->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dquerytype, IDirect3DQuery9.Native**, HResult> )(lpVtbl[118]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Type, &ppQuery->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, D3Dformat, D3DmultisampleType, uint, MaybeBool<int>, IDirect3DSurface9.Native**, Handle*, HResult> )(lpVtbl[28]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Width, Height, Format, MultiSample, MultisampleQuality, Lockable, &ppSurface->LpVtbl, pSharedHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dstateblocktype, IDirect3DStateBlock9.Native**, HResult> )(lpVtbl[59]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Type, &ppSB->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, uint, uint, D3Dformat, D3Dpool, IDirect3DTexture9.Native**, Handle*, HResult> )(lpVtbl[23]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Width, Height, Levels, Usage, Format, Pool, &ppTexture->LpVtbl, pSharedHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, uint, D3Dpool, IDirect3DVertexBuffer9.Native**, Handle*, HResult> )(lpVtbl[26]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Length, Usage, FVF, Pool, &ppVertexBuffer->LpVtbl, pSharedHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dvertexelement9*, IDirect3DVertexDeclaration9.Native**, HResult> )(lpVtbl[86]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pVertexElements, &ppDecl->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint*, IDirect3DVertexShader9.Native**, HResult> )(lpVtbl[91]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pFunction, &ppShader->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, uint, uint, uint, D3Dformat, D3Dpool, IDirect3DVolumeTexture9.Native**, Handle*, HResult> )(lpVtbl[24]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Width, Height, Depth, Levels, Usage, Format, Pool, &ppVolumeTexture->LpVtbl, pSharedHandle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, HResult> )(lpVtbl[117]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Handle);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dprimitivetype, int, uint, uint, uint, uint, HResult> )(lpVtbl[82]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), param0, BaseVertexIndex, MinVertexIndex, NumVertices, startIndex, primCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dprimitivetype, uint, uint, uint, void*, D3Dformat, void*, uint, HResult> )(lpVtbl[84]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), PrimitiveType, MinVertexIndex, NumVertices, PrimitiveCount, pIndexData, IndexDataFormat, pVertexStreamZeroData, VertexStreamZeroStride);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dprimitivetype, uint, uint, HResult> )(lpVtbl[81]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), PrimitiveType, StartVertex, PrimitiveCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dprimitivetype, uint, void*, uint, HResult> )(lpVtbl[83]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), PrimitiveType, PrimitiveCount, pVertexStreamZeroData, VertexStreamZeroStride);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, float*, D3DrectpatchInfo*, HResult> )(lpVtbl[115]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Handle, pNumSegs, pRectPatchInfo);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, float*, D3DtripatchInfo*, HResult> )(lpVtbl[116]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Handle, pNumSegs, pTriPatchInfo);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, HResult> )(lpVtbl[42]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DStateBlock9.Native**, HResult> )(lpVtbl[61]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), &ppSB->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, HResult> )(lpVtbl[5]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint> )(lpVtbl[4]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, D3DbackbufferType, IDirect3DSurface9.Native**, HResult> )(lpVtbl[18]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), iSwapChain, iBackBuffer, Type, &ppBackBuffer->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, float*, HResult> )(lpVtbl[56]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Index, pPlane);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dclipstatus9*, HResult> )(lpVtbl[63]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pClipStatus);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3DdeviceCreationParameters*, HResult> )(lpVtbl[9]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pParameters);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint*, HResult> )(lpVtbl[74]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), PaletteNumber);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DSurface9.Native**, HResult> )(lpVtbl[40]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), &ppZStencilSurface->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dcaps9*, HResult> )(lpVtbl[7]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pCaps);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3D9.Native**, HResult> )(lpVtbl[6]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), &ppD3D9->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Ddisplaymode*, HResult> )(lpVtbl[8]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), iSwapChain, pMode);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, IDirect3DSurface9.Native*, HResult> )(lpVtbl[33]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), iSwapChain, pDestSurface.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint*, HResult> )(lpVtbl[90]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pFVF);
        }
        ...
        {
            ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Dgammaramp*, void> )(lpVtbl[22]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), iSwapChain, pRamp);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DIndexBuffer9.Native**, HResult> )(lpVtbl[105]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), &ppIndexData->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Dlight9*, HResult> )(lpVtbl[52]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Index, param1);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, MaybeBool<int>*, HResult> )(lpVtbl[54]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Index, pEnable);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dmaterial9*, HResult> )(lpVtbl[50]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pMaterial);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, float> )(lpVtbl[80]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint> )(lpVtbl[15]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, PALETTEENTRY*, HResult> )(lpVtbl[72]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), PaletteNumber, pEntries);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DPixelShader9.Native**, HResult> )(lpVtbl[108]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), &ppShader->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, MaybeBool<int>*, uint, HResult> )(lpVtbl[114]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, BoolCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, float*, uint, HResult> )(lpVtbl[110]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, Vector4fCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, int*, uint, HResult> )(lpVtbl[112]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, Vector4iCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3DrasterStatus*, HResult> )(lpVtbl[19]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), iSwapChain, pRasterStatus);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Drenderstatetype, uint*, HResult> )(lpVtbl[58]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), State, pValue);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, IDirect3DSurface9.Native**, HResult> )(lpVtbl[38]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), RenderTargetIndex, &ppRenderTarget->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DSurface9.Native*, IDirect3DSurface9.Native*, HResult> )(lpVtbl[32]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pRenderTarget.LpVtbl, pDestSurface.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Dsamplerstatetype, uint*, HResult> )(lpVtbl[68]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Sampler, Type, pValue);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, RECT*, HResult> )(lpVtbl[76]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pRect);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, MaybeBool<int>> )(lpVtbl[78]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, IDirect3DVertexBuffer9.Native**, uint*, uint*, HResult> )(lpVtbl[101]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StreamNumber, &ppStreamData->LpVtbl, pOffsetInBytes, pStride);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint*, HResult> )(lpVtbl[103]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StreamNumber, pSetting);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, IDirect3DSwapChain9.Native**, HResult> )(lpVtbl[14]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), iSwapChain, &pSwapChain->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, IDirect3DBaseTexture9.Native**, HResult> )(lpVtbl[64]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Stage, &ppTexture->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Dtexturestagestatetype, uint*, HResult> )(lpVtbl[66]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Stage, Type, pValue);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dtransformstatetype, D2DMatrix4X4F*, HResult> )(lpVtbl[45]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), State, pMatrix);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DVertexDeclaration9.Native**, HResult> )(lpVtbl[88]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), &ppDecl->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DVertexShader9.Native**, HResult> )(lpVtbl[93]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), &ppShader->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, MaybeBool<int>*, uint, HResult> )(lpVtbl[99]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, BoolCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, float*, uint, HResult> )(lpVtbl[95]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, Vector4fCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, int*, uint, HResult> )(lpVtbl[97]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, Vector4iCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dviewport9*, HResult> )(lpVtbl[48]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pViewport);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, MaybeBool<int>, HResult> )(lpVtbl[53]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Index, Enable);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dtransformstatetype, D2DMatrix4X4F*, HResult> )(lpVtbl[46]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, RECT*, RECT*, HWND, RGNDATA*, HResult> )(lpVtbl[17]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pSourceRect, pDestRect, hDestWindowOverride, pDirtyRegion);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, uint, IDirect3DVertexBuffer9.Native*, IDirect3DVertexDeclaration9.Native*, uint, HResult> )(lpVtbl[85]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), SrcStartIndex, DestIndex, VertexCount, pDestBuffer.LpVtbl, pVertexDecl.LpVtbl, Flags);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint> )(lpVtbl[2]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3DpresentParameters*, HResult> )(lpVtbl[16]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pPresentationParameters);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, float*, HResult> )(lpVtbl[55]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Index, pPlane);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dclipstatus9*, HResult> )(lpVtbl[62]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pClipStatus);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, HResult> )(lpVtbl[73]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), PaletteNumber);
        }
        ...
        {
            ((delegate* unmanaged<IDirect3DDevice9.Native*, int, int, uint, void> )(lpVtbl[11]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), X, Y, Flags);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, IDirect3DSurface9.Native*, HResult> )(lpVtbl[10]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), XHotSpot, YHotSpot, pCursorBitmap.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DSurface9.Native*, HResult> )(lpVtbl[39]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pNewZStencil.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, MaybeBool<int>, HResult> )(lpVtbl[20]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), bEnableDialogs);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, HResult> )(lpVtbl[89]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), FVF);
        }
        ...
        {
            ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, D3Dgammaramp*, void> )(lpVtbl[21]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), iSwapChain, Flags, pRamp);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DIndexBuffer9.Native*, HResult> )(lpVtbl[104]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pIndexData.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Dlight9*, HResult> )(lpVtbl[51]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Index, param1);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dmaterial9*, HResult> )(lpVtbl[49]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pMaterial);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, float, HResult> )(lpVtbl[79]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), nSegments);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, PALETTEENTRY*, HResult> )(lpVtbl[71]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), PaletteNumber, pEntries);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DPixelShader9.Native*, HResult> )(lpVtbl[107]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pShader.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, MaybeBool<int>*, uint, HResult> )(lpVtbl[113]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, BoolCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, float*, uint, HResult> )(lpVtbl[109]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, Vector4fCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, int*, uint, HResult> )(lpVtbl[111]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, Vector4iCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Drenderstatetype, uint, HResult> )(lpVtbl[57]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), State, Value);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, IDirect3DSurface9.Native*, HResult> )(lpVtbl[37]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), RenderTargetIndex, pRenderTarget.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Dsamplerstatetype, uint, HResult> )(lpVtbl[69]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Sampler, Type, Value);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, RECT*, HResult> )(lpVtbl[75]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pRect);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, MaybeBool<int>, HResult> )(lpVtbl[77]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), bSoftware);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, IDirect3DVertexBuffer9.Native*, uint, uint, HResult> )(lpVtbl[100]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StreamNumber, pStreamData.LpVtbl, OffsetInBytes, Stride);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, uint, HResult> )(lpVtbl[102]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StreamNumber, Setting);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, IDirect3DBaseTexture9.Native*, HResult> )(lpVtbl[65]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Stage, pTexture.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, D3Dtexturestagestatetype, uint, HResult> )(lpVtbl[67]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), Stage, Type, Value);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dtransformstatetype, D2DMatrix4X4F*, HResult> )(lpVtbl[44]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), State, pMatrix);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DVertexDeclaration9.Native*, HResult> )(lpVtbl[87]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pDecl.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DVertexShader9.Native*, HResult> )(lpVtbl[92]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pShader.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, MaybeBool<int>*, uint, HResult> )(lpVtbl[98]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, BoolCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, float*, uint, HResult> )(lpVtbl[94]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, Vector4fCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint, int*, uint, HResult> )(lpVtbl[96]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), StartRegister, pConstantData, Vector4iCount);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, D3Dviewport9*, HResult> )(lpVtbl[47]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pViewport);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, MaybeBool<int>, MaybeBool<int>> )(lpVtbl[12]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), bShow);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DSurface9.Native*, RECT*, IDirect3DSurface9.Native*, RECT*, D3Dtexturefiltertype, HResult> )(lpVtbl[34]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pSourceSurface.LpVtbl, pSourceRect, pDestSurface.LpVtbl, pDestRect, Filter);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, HResult> )(lpVtbl[3]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DSurface9.Native*, RECT*, IDirect3DSurface9.Native*, Point*, HResult> )(lpVtbl[30]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pSourceSurface.LpVtbl, pSourceRect, pDestinationSurface.LpVtbl, pDestPoint);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, IDirect3DBaseTexture9.Native*, IDirect3DBaseTexture9.Native*, HResult> )(lpVtbl[31]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pSourceTexture.LpVtbl, pDestinationTexture.LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IDirect3DDevice9.Native*, uint*, HResult> )(lpVtbl[70]))((IDirect3DDevice9.Native*)Unsafe.AsPointer(ref this), pNumPasses);
        }
    ...
    public IDirect3DDevice9(Ptr3D vtbl) => LpVtbl = (IDirect3DDevice9.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "IDirect3DDevice9"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDirect3DDevice9(Ptr<IDirect3DDevice9.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "IDirect3DDevice9.Native"/> to <see cref = "IDirect3DDevice9"/>.</summary>
    /// <param name = "value">The <see cref = "IDirect3DDevice9.Native"/> instance to be converted </param>
    public static implicit operator IDirect3DDevice9(IDirect3DDevice9.Native* value) => new IDirect3DDevice9((Ptr<Native>)value);
    /// <summary>casts <see cref = "IDirect3DDevice9"/> to <see cref = "IDirect3DDevice9.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "IDirect3DDevice9"/> instance to be converted </param>
    public static implicit operator IDirect3DDevice9.Native*(IDirect3DDevice9 value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "IDirect3DDevice9"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator IDirect3DDevice9(Ptr3D value) => new IDirect3DDevice9(value);
    /// <summary>casts <see cref = "IDirect3DDevice9"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "IDirect3DDevice9"/> instance to be converted </param>
    public static implicit operator Ptr3D(IDirect3DDevice9 value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "IDirect3DDevice9"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator IDirect3DDevice9(Ptr<IDirect3DDevice9.Native> value) => new IDirect3DDevice9(value);
    /// <summary>casts <see cref = "IDirect3DDevice9"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "IDirect3DDevice9"/> instance to be converted </param>
    public static implicit operator Ptr<IDirect3DDevice9.Native>(IDirect3DDevice9 value) => (Ptr<IDirect3DDevice9.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "IDirect3DDevice9"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator IDirect3DDevice9(void*** value) => new IDirect3DDevice9((Ptr<Native>)value);
    /// <summary>casts <see cref = "IDirect3DDevice9"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "IDirect3DDevice9"/> instance to be converted </param>
    public static implicit operator void***(IDirect3DDevice9 value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "IDirect3DDevice9"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator IDirect3DDevice9(nuint value) => new IDirect3DDevice9((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "IDirect3DDevice9"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "IDirect3DDevice9"/> instance to be converted </param>
    public static implicit operator nuint(IDirect3DDevice9 value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
