...
public unsafe partial struct IdxgiAdapter2 : IdxgiAdapter2.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IdxgiAdapter2));

    public interface Interface : IdxgiAdapter1.Interface
    {
        [VtblIndex(11)]
        HResult GetDesc2(DxgiAdapterDesc2* pDesc);

        [VtblIndex(11)]
        [MethodImpl(
            MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization
        )]
        HResult GetDesc2(Ref<DxgiAdapterDesc2> pDesc);
    }
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IdxgiAdapter2.Native*, uint>)(lpVtbl[1]))(
                (IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, Guid*, LargeInteger*, HResult>)(
                    lpVtbl[9]
                )
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), InterfaceName, pUMDVersion);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, uint, IdxgiOutput.Native**, HResult>)(
                    lpVtbl[7]
                )
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), Output, &ppOutput->LpVtbl);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, DxgiAdapterDesc*, HResult>)(lpVtbl[8])
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), pDesc);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, DxgiAdapterDesc1*, HResult>)(lpVtbl[10])
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), pDesc);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, DxgiAdapterDesc2*, HResult>)(lpVtbl[11])
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), pDesc);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, Guid*, void**, HResult>)(lpVtbl[6])
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), riid, ppParent);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, Guid*, uint*, void*, HResult>)(
                    lpVtbl[5]
                )
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), Name, pDataSize, pData);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, Guid*, void**, HResult>)(lpVtbl[0])
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IdxgiAdapter2.Native*, uint>)(lpVtbl[2]))(
                (IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, Guid*, uint, void*, HResult>)(lpVtbl[3])
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), Name, DataSize, pData);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiAdapter2.Native*, Guid*, IUnknown.Native*, HResult>)(
                    lpVtbl[4]
                )
            )((IdxgiAdapter2.Native*)Unsafe.AsPointer(ref this), Name, pUnknown.lpVtbl);
        }
    ...
    public IdxgiAdapter2(Ptr3D vtbl) => LpVtbl = (IdxgiAdapter2.Native*)vtbl;

    /// <summary>Initializes a new instance of the <see cref = "IdxgiAdapter2"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>

    public IdxgiAdapter2(Ptr<IdxgiAdapter2.Native> vtbl) => LpVtbl = vtbl;

    /// <summary>casts <see cref = "IdxgiAdapter2.Native"/> to <see cref = "IdxgiAdapter2"/>.</summary>
    /// <param name = "value">The <see cref = "IdxgiAdapter2.Native"/> instance to be converted </param>

    public static implicit operator IdxgiAdapter2(IdxgiAdapter2.Native* value) =>
        new IdxgiAdapter2((Ptr<Native>)value);

    /// <summary>casts <see cref = "IdxgiAdapter2"/> to <see cref = "IdxgiAdapter2.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "IdxgiAdapter2"/> instance to be converted </param>

    public static implicit operator IdxgiAdapter2.Native*(IdxgiAdapter2 value) => value.LpVtbl;

    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "IdxgiAdapter2"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>

    public static explicit operator IdxgiAdapter2(Ptr3D value) => new IdxgiAdapter2(value);

    /// <summary>casts <see cref = "IdxgiAdapter2"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiAdapter2"/> instance to be converted </param>

    public static implicit operator Ptr3D(IdxgiAdapter2 value) => (Ptr3D)value.LpVtbl;

    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "IdxgiAdapter2"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>

    public static explicit operator IdxgiAdapter2(Ptr<IdxgiAdapter2.Native> value) =>
        new IdxgiAdapter2(value);

    /// <summary>casts <see cref = "IdxgiAdapter2"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiAdapter2"/> instance to be converted </param>

    public static implicit operator Ptr<IdxgiAdapter2.Native>(IdxgiAdapter2 value) =>
        (Ptr<IdxgiAdapter2.Native>)value.LpVtbl;

    /// <summary>casts void*** to <see cref = "IdxgiAdapter2"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>

    public static explicit operator IdxgiAdapter2(void*** value) =>
        new IdxgiAdapter2((Ptr<Native>)value);

    /// <summary>casts <see cref = "IdxgiAdapter2"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "IdxgiAdapter2"/> instance to be converted </param>

    public static implicit operator void***(IdxgiAdapter2 value) => (void***)value.LpVtbl;

    /// <summary>casts <see cref = "nuint"/> to <see cref = "IdxgiAdapter2"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>

    public static explicit operator IdxgiAdapter2(nuint value) =>
        new IdxgiAdapter2((Ptr<Native>)value.ToPointer());

    /// <summary>casts <see cref = "IdxgiAdapter2"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiAdapter2"/> instance to be converted </param>

    public static implicit operator nuint(IdxgiAdapter2 value) => (nuint)value.LpVtbl;
