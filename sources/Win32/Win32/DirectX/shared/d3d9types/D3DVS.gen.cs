...
public static partial class D3Dvs
{
    ...
    public const int AddressmodeShift = 13;

    [NativeTypeName("#define D3DVS_ADDRESSMODE_MASK (1 << D3DVS_ADDRESSMODE_SHIFT)")]
    public const int AddressmodeMask = (1 << 13);
