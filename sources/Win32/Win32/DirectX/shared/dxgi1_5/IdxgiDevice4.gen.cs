...
public unsafe partial struct IdxgiDevice4 : IdxgiDevice4.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IdxgiDevice4));
    ...
    public interface Interface : IdxgiDevice3.Interface
    {
        ...
        HResult ReclaimResources1(
            uint NumResources,
            [NativeTypeName("IDXGIResource *const *")] IdxgiResource* ppResources,
            DxgiReclaimResourceResults* pResults
        );
        ...
        HResult ReclaimResources1(
            uint NumResources,
            [NativeTypeName("IDXGIResource *const *")] Ref<IdxgiResource> ppResources,
            Ref<DxgiReclaimResourceResults> pResults
        );
    }
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, uint>)(lpVtbl[1]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, Handle, HResult>)(lpVtbl[16]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this),
                hEvent
            );
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiDevice4.Native*, IdxgiAdapter.Native**, HResult>)(
                    lpVtbl[7]
                )
            )((IdxgiDevice4.Native*)Unsafe.AsPointer(ref this), &pAdapter->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, int*, HResult>)(lpVtbl[11]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this),
                pPriority
            );
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, uint*, HResult>)(lpVtbl[13]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this),
                pMaxLatency
            );
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, Guid*, void**, HResult>)(lpVtbl[6]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this),
                riid,
                ppParent
            );
        ...
        {
            return (
                (delegate* unmanaged<IdxgiDevice4.Native*, Guid*, uint*, void*, HResult>)(lpVtbl[5])
            )((IdxgiDevice4.Native*)Unsafe.AsPointer(ref this), Name, pDataSize, pData);
        }
        ...
        )
        {
            fixed (IdxgiResource* __dsl_ppResources = ppResources)
            {
                return (HResult)OfferResources1(NumResources, __dsl_ppResources, Priority, Flags);
            }
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, Guid*, void**, HResult>)(lpVtbl[0]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this),
                riid,
                ppvObject
            );
        ...
        {
            fixed (DxgiReclaimResourceResults* __dsl_pResults = pResults)
            fixed (IdxgiResource* __dsl_ppResources = ppResources)
            {
                return (HResult)ReclaimResources1(NumResources, __dsl_ppResources, __dsl_pResults);
            }
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, uint>)(lpVtbl[2]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, int, HResult>)(lpVtbl[10]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this),
                Priority
            );
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiDevice4.Native*, uint, HResult>)(lpVtbl[12]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this),
                MaxLatency
            );
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiDevice4.Native*, Guid*, uint, void*, HResult>)(lpVtbl[3])
            )((IdxgiDevice4.Native*)Unsafe.AsPointer(ref this), Name, DataSize, pData);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiDevice4.Native*, Guid*, IUnknown.Native*, HResult>)(
                    lpVtbl[4]
                )
            )((IdxgiDevice4.Native*)Unsafe.AsPointer(ref this), Name, pUnknown.lpVtbl);
        }
        ...
        public void Trim()
        {
            ((delegate* unmanaged<IdxgiDevice4.Native*, void>)(lpVtbl[17]))(
                (IdxgiDevice4.Native*)Unsafe.AsPointer(ref this)
            );
        }
    }
    ...
    public IdxgiDevice4(Ptr3D vtbl) => LpVtbl = (IdxgiDevice4.Native*)vtbl;

    /// <summary>Initializes a new instance of the <see cref = "IdxgiDevice4"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>

    public IdxgiDevice4(Ptr<IdxgiDevice4.Native> vtbl) => LpVtbl = vtbl;

    /// <summary>casts <see cref = "IdxgiDevice4.Native"/> to <see cref = "IdxgiDevice4"/>.</summary>
    /// <param name = "value">The <see cref = "IdxgiDevice4.Native"/> instance to be converted </param>

    public static implicit operator IdxgiDevice4(IdxgiDevice4.Native* value) =>
        new IdxgiDevice4((Ptr<Native>)value);

    /// <summary>casts <see cref = "IdxgiDevice4"/> to <see cref = "IdxgiDevice4.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "IdxgiDevice4"/> instance to be converted </param>

    public static implicit operator IdxgiDevice4.Native*(IdxgiDevice4 value) => value.LpVtbl;

    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "IdxgiDevice4"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>

    public static explicit operator IdxgiDevice4(Ptr3D value) => new IdxgiDevice4(value);

    /// <summary>casts <see cref = "IdxgiDevice4"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiDevice4"/> instance to be converted </param>

    public static implicit operator Ptr3D(IdxgiDevice4 value) => (Ptr3D)value.LpVtbl;

    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "IdxgiDevice4"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>

    public static explicit operator IdxgiDevice4(Ptr<IdxgiDevice4.Native> value) =>
        new IdxgiDevice4(value);

    /// <summary>casts <see cref = "IdxgiDevice4"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiDevice4"/> instance to be converted </param>

    public static implicit operator Ptr<IdxgiDevice4.Native>(IdxgiDevice4 value) =>
        (Ptr<IdxgiDevice4.Native>)value.LpVtbl;

    /// <summary>casts void*** to <see cref = "IdxgiDevice4"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>

    public static explicit operator IdxgiDevice4(void*** value) =>
        new IdxgiDevice4((Ptr<Native>)value);

    /// <summary>casts <see cref = "IdxgiDevice4"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "IdxgiDevice4"/> instance to be converted </param>

    public static implicit operator void***(IdxgiDevice4 value) => (void***)value.LpVtbl;

    /// <summary>casts <see cref = "nuint"/> to <see cref = "IdxgiDevice4"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>

    public static explicit operator IdxgiDevice4(nuint value) =>
        new IdxgiDevice4((Ptr<Native>)value.ToPointer());

    /// <summary>casts <see cref = "IdxgiDevice4"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiDevice4"/> instance to be converted </param>

    public static implicit operator nuint(IdxgiDevice4 value) => (nuint)value.LpVtbl;
    ...
    public HResult OfferResources1(
        ...
        DxgiOfferResourcePriority Priority,
        uint Flags
    ) => LpVtbl->OfferResources1(NumResources, ppResources, Priority, Flags);
    ...
    public HResult ReclaimResources1(
        ...
        [NativeTypeName("IDXGIResource *const *")] IdxgiResource* ppResources,
        DxgiReclaimResourceResults* pResults
    ) => LpVtbl->ReclaimResources1(NumResources, ppResources, pResults);
