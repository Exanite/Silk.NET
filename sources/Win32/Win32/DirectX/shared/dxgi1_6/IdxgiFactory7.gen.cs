...
public unsafe partial struct IdxgiFactory7 : IdxgiFactory7.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IdxgiFactory7));
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
            ...
            where TSelf : unmanaged, Interface
        {
            ...
            [NativeTypeName("HRESULT (HANDLE, DWORD *) __attribute__((stdcall))")]
            public delegate* unmanaged<TSelf*, Handle, uint*, HResult> RegisterAdaptersChangedEvent;

            [NativeTypeName("HRESULT (DWORD) __attribute__((stdcall))")]
            public delegate* unmanaged<TSelf*, uint, HResult> UnregisterAdaptersChangedEvent;
        }
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IdxgiFactory7.Native*, uint>)(lpVtbl[1]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, DxgiFeature, void*, uint, HResult>)(
                    lpVtbl[28]
                )
            )(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this),
        ...
        public HResult CheckFeatureSupport(
            DxgiFeature Feature,
            Ref pFeatureSupportData,
            uint FeatureSupportDataSize
        )
        {
            fixed (void* __dsl_pFeatureSupportData = pFeatureSupportData)
            {
                return (HResult)CheckFeatureSupport(
                    Feature,
                    __dsl_pFeatureSupportData,
                    FeatureSupportDataSize
                );
            }
        }
        ...
        public HResult CreateSoftwareAdapter(Hmodule Module, IdxgiAdapter* ppAdapter)
        {
            return (
                (delegate* unmanaged<
                    IdxgiFactory7.Native*,
                    Hmodule,
                    IdxgiAdapter.Native**,
                    HResult>)(lpVtbl[11])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), Module, &ppAdapter->LpVtbl);
        }
        ...
        public HResult EnumAdapterByGpuPreference(
            uint Adapter,
            DxgiGpuPreference GpuPreference,
        ...
        )
        {
            ...
            {
                return (HResult)EnumAdapterByGpuPreference(
                    Adapter,
                    GpuPreference,
                    __dsl_riid,
                    __dsl_ppvAdapter
        ...
        [VtblIndex(29)]
        [Transformed]
        public HResult EnumAdapterByGpuPreference<TCom>(
            uint Adapter,
            DxgiGpuPreference GpuPreference,
            out TCom ppvAdapter
        )
        ...
        {
            ppvAdapter = default;
            return EnumAdapterByGpuPreference(
                Adapter,
                GpuPreference,
                TCom.NativeGuid,
                ppvAdapter.GetAddressOf()
            );
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, LUID, Guid*, void**, HResult>)(
                    lpVtbl[26]
                )
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), AdapterLuid, riid, ppvAdapter);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, uint, IdxgiAdapter.Native**, HResult>)(
                    lpVtbl[7]
                )
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), Adapter, &ppAdapter->LpVtbl);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, uint, IdxgiAdapter1.Native**, HResult>)(
                    lpVtbl[12]
                )
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), Adapter, &ppAdapter->LpVtbl);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Guid*, void**, HResult>)(lpVtbl[27])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), riid, ppvAdapter);
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiFactory7.Native*, uint>)(lpVtbl[25]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Guid*, void**, HResult>)(lpVtbl[6])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), riid, ppParent);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Guid*, uint*, void*, HResult>)(
                    lpVtbl[5]
                )
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), Name, pDataSize, pData);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Handle, LUID*, HResult>)(lpVtbl[17])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), hResource, pLuid);
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiFactory7.Native*, HWND*, HResult>)(lpVtbl[9]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this),
                pWindowHandle
            );
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiFactory7.Native*, MaybeBool<int>>)(lpVtbl[13]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiFactory7.Native*, MaybeBool<int>>)(lpVtbl[14]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiFactory7.Native*, HWND, uint, HResult>)(lpVtbl[8]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this),
                WindowHandle,
                Flags
            );
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Guid*, void**, HResult>)(lpVtbl[0])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [VtblIndex(30)]
        public HResult RegisterAdaptersChangedEvent(
            Handle hEvent,
            [NativeTypeName("DWORD *")] uint* pdwCookie
        )
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Handle, uint*, HResult>)(lpVtbl[30])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), hEvent, pdwCookie);
        }
        ...
        )
        {
            ...
            {
                return (HResult)RegisterAdaptersChangedEvent(hEvent, __dsl_pdwCookie);
            }
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Handle, uint*, HResult>)(lpVtbl[22])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), hEvent, pdwCookie);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, HWND, uint, uint*, HResult>)(lpVtbl[21])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), WindowHandle, wMsg, pdwCookie);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Handle, uint*, HResult>)(lpVtbl[19])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), hEvent, pdwCookie);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, HWND, uint, uint*, HResult>)(lpVtbl[18])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), WindowHandle, wMsg, pdwCookie);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IdxgiFactory7.Native*, uint>)(lpVtbl[2]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this)
            );
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Guid*, uint, void*, HResult>)(lpVtbl[3])
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), Name, DataSize, pData);
        }
        ...
        {
            return (
                (delegate* unmanaged<IdxgiFactory7.Native*, Guid*, IUnknown.Native*, HResult>)(
                    lpVtbl[4]
                )
            )((IdxgiFactory7.Native*)Unsafe.AsPointer(ref this), Name, pUnknown.lpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<IdxgiFactory7.Native*, uint, HResult>)(lpVtbl[31]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this),
                dwCookie
            );
        }
        ...
        {
            ((delegate* unmanaged<IdxgiFactory7.Native*, uint, void>)(lpVtbl[23]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this),
                dwCookie
            );
        }
        ...
        {
            ((delegate* unmanaged<IdxgiFactory7.Native*, uint, void>)(lpVtbl[20]))(
                (IdxgiFactory7.Native*)Unsafe.AsPointer(ref this),
                dwCookie
            );
        }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IdxgiFactory7"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>

    public IdxgiFactory7(Ptr3D vtbl) => LpVtbl = (IdxgiFactory7.Native*)vtbl;

    /// <summary>Initializes a new instance of the <see cref = "IdxgiFactory7"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>

    public IdxgiFactory7(Ptr<IdxgiFactory7.Native> vtbl) => LpVtbl = vtbl;

    /// <summary>casts <see cref = "IdxgiFactory7.Native"/> to <see cref = "IdxgiFactory7"/>.</summary>
    /// <param name = "value">The <see cref = "IdxgiFactory7.Native"/> instance to be converted </param>

    public static implicit operator IdxgiFactory7(IdxgiFactory7.Native* value) =>
        new IdxgiFactory7((Ptr<Native>)value);

    /// <summary>casts <see cref = "IdxgiFactory7"/> to <see cref = "IdxgiFactory7.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "IdxgiFactory7"/> instance to be converted </param>

    public static implicit operator IdxgiFactory7.Native*(IdxgiFactory7 value) => value.LpVtbl;

    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "IdxgiFactory7"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>

    public static explicit operator IdxgiFactory7(Ptr3D value) => new IdxgiFactory7(value);

    /// <summary>casts <see cref = "IdxgiFactory7"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiFactory7"/> instance to be converted </param>

    public static implicit operator Ptr3D(IdxgiFactory7 value) => (Ptr3D)value.LpVtbl;

    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "IdxgiFactory7"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>

    public static explicit operator IdxgiFactory7(Ptr<IdxgiFactory7.Native> value) =>
        new IdxgiFactory7(value);

    /// <summary>casts <see cref = "IdxgiFactory7"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiFactory7"/> instance to be converted </param>

    public static implicit operator Ptr<IdxgiFactory7.Native>(IdxgiFactory7 value) =>
        (Ptr<IdxgiFactory7.Native>)value.LpVtbl;

    /// <summary>casts void*** to <see cref = "IdxgiFactory7"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>

    public static explicit operator IdxgiFactory7(void*** value) =>
        new IdxgiFactory7((Ptr<Native>)value);

    /// <summary>casts <see cref = "IdxgiFactory7"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "IdxgiFactory7"/> instance to be converted </param>

    public static implicit operator void***(IdxgiFactory7 value) => (void***)value.LpVtbl;

    /// <summary>casts <see cref = "nuint"/> to <see cref = "IdxgiFactory7"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>

    public static explicit operator IdxgiFactory7(nuint value) =>
        new IdxgiFactory7((Ptr<Native>)value.ToPointer());

    /// <summary>casts <see cref = "IdxgiFactory7"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "IdxgiFactory7"/> instance to be converted </param>

    public static implicit operator nuint(IdxgiFactory7 value) => (nuint)value.LpVtbl;
    ...
    public HResult CheckFeatureSupport(
        ...
        void* pFeatureSupportData,
        uint FeatureSupportDataSize
    ) => LpVtbl->CheckFeatureSupport(Feature, pFeatureSupportData, FeatureSupportDataSize);
    ...
    public HResult EnumAdapterByGpuPreference(
        ...
        [NativeTypeName("const IID &")] Guid* riid,
        void** ppvAdapter
    ) => LpVtbl->EnumAdapterByGpuPreference(Adapter, GpuPreference, riid, ppvAdapter);
    ...
    public HResult RegisterAdaptersChangedEvent(
        Handle hEvent,
        [NativeTypeName("DWORD *")] uint* pdwCookie
    ) => LpVtbl->RegisterAdaptersChangedEvent(hEvent, pdwCookie);
    ...
    [VtblIndex(31)]
    public HResult UnregisterAdaptersChangedEvent([NativeTypeName("DWORD")] uint dwCookie) =>
        LpVtbl->UnregisterAdaptersChangedEvent(dwCookie);
