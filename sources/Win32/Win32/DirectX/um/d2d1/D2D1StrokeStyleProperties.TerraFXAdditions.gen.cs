...
public partial struct D2D1StrokeStyleProperties
{
    public static ref readonly D2D1StrokeStyleProperties DEFAULT
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D2D1StrokeStyleProperties>());
            return ref Unsafe.As<byte, D2D1StrokeStyleProperties>(
    ...
    {
        this = DirectX.StrokeStyleProperties(
            startCap,
            endCap,
            dashCap,
            lineJoin,
