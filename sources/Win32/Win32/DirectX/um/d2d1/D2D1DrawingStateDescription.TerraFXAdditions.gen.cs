...
public partial struct D2D1DrawingStateDescription
{
    public static ref readonly D2D1DrawingStateDescription DEFAULT
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D2D1DrawingStateDescription>());
            return ref Unsafe.As<byte, D2D1DrawingStateDescription>(
    ...
    public D2D1_DRAWING_STATE_DESCRIPTION(
        ...
        : this(antialiasMode, textAntialiasMode, tag1, tag2, DirectX.IdentityMatrix) { }
    ...
    {
        this = DirectX.DrawingStateDescription(
            antialiasMode,
            textAntialiasMode,
            tag1,
            tag2,
