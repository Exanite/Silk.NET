...
public partial struct D2D1RenderTargetProperties
{
    public static ref readonly D2D1RenderTargetProperties DEFAULT
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D2D1RenderTargetProperties>());
            return ref Unsafe.As<byte, D2D1RenderTargetProperties>(
    ...
    {
        this = DirectX.RenderTargetProperties(type, pixelFormat, dpiX, dpiY, usage, minLevel);
    }
}
