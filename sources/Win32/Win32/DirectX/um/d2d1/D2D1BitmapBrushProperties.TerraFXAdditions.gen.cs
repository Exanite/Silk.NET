...
public partial struct D2D1BitmapBrushProperties
{
    public static ref readonly D2D1BitmapBrushProperties DEFAULT
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D2D1BitmapBrushProperties>());
            return ref Unsafe.As<byte, D2D1BitmapBrushProperties>(
    ...
    {
        this = DirectX.BitmapBrushProperties(extendModeX, extendModeY, interpolationMode);
    }
}
