...
public partial struct D2D1PixelFormat
{
    public static ref readonly D2D1PixelFormat DEFAULT
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get
        {
            ReadOnlySpan<byte> data = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
            Debug.Assert(data.Length == Unsafe.SizeOf<D2D1PixelFormat>());
            return ref Unsafe.As<byte, D2D1PixelFormat>(ref MemoryMarshal.GetReference(data));
        }
    }
