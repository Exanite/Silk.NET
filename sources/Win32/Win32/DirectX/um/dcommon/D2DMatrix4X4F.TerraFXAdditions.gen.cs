...
public unsafe partial struct D2DMatrix4X4F : IEquatable<D2DMatrix4X4F>
{
    ...
    public static ref readonly D2DMatrix4X4F Identity
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D2DMatrix4X4F>());
            return ref Unsafe.As<byte, D2DMatrix4X4F>(ref MemoryMarshal.GetReference(data));
        }
    }

    public static bool operator ==(
        [NativeTypeName("const D2D1_MATRIX_4X4_F &")] in D2DMatrix4X4F l,
        [NativeTypeName("const D2D1_MATRIX_4X4_F &")] in D2DMatrix4X4F r
    )
    {
        return (l._11 == r._11)
            && (l._12 == r._12)
    ...
    public static D2DMatrix4X4F operator *(
        [NativeTypeName("const D2D1_MATRIX_4x4_F &")] in D2DMatrix4X4F a,
        [NativeTypeName("const D2D1_MATRIX_4x4_F &")] in D2DMatrix4X4F b
    )
    {
        D2DMatrix4X4F result = default;
        result.SetProduct(a, b);
        return result;
    }

    public readonly bool Equals(D2DMatrix4X4F other) => this == other;

    public override readonly bool Equals(object? obj) =>
        (obj is D2DMatrix4X4F other) && this == other;
    ...
    public static D2DMatrix4X4F PerspectiveProjection(float depth)
    {
        float proj = 0;
        if (depth > 0)
        {
        ...
        D2DMatrix4X4F projection = new D2DMatrix4X4F(
            1,
            0,
            0,
            0,
    ...
    public static D2DMatrix4X4F RotationArbitraryAxis(float x, float y, float z, float degree)
    {
        ...
        D2DMatrix4X4F rotationArb = new D2DMatrix4X4F(
    ...
    public static D2DMatrix4X4F RotationX(float degreeX)
    {
        float angleInRadian = degreeX * (MathF.PI / 180.0f);
        float sinAngle = 0.0f;
        float cosAngle = 0.0f;
        D2D1SinCos(angleInRadian, &sinAngle, &cosAngle);
        D2DMatrix4X4F rotationX = new D2DMatrix4X4F(
            1,
            0,
            0,
            0,
    ...
    public static D2DMatrix4X4F RotationY(float degreeY)
    {
        float angleInRadian = degreeY * (MathF.PI / 180.0f);
        float sinAngle = 0.0f;
        float cosAngle = 0.0f;
        D2D1SinCos(angleInRadian, &sinAngle, &cosAngle);
        D2DMatrix4X4F rotationY = new D2DMatrix4X4F(
            cosAngle,
            0,
            -sinAngle,
            0,
    ...
    public static D2DMatrix4X4F RotationZ(float degreeZ)
    {
        float angleInRadian = degreeZ * (MathF.PI / 180.0f);
        float sinAngle = 0.0f;
        float cosAngle = 0.0f;
        D2D1SinCos(angleInRadian, &sinAngle, &cosAngle);
        D2DMatrix4X4F rotationZ = new D2DMatrix4X4F(
            cosAngle,
            sinAngle,
            0,
            0,
    ...
    public static D2DMatrix4X4F Scale(float x, float y, float z)
    {
        D2DMatrix4X4F scale = default;
        scale._11 = x;
        scale._12 = 0.0f;
        scale._13 = 0.0f;
        scale._14 = 0.0f;
    ...
    public static D2DMatrix4X4F SkewX(float degreeX)
    {
        float angleInRadian = degreeX * (3.141592654f / 180.0f);
        float tanAngle = D2D1Tan(angleInRadian);
        D2DMatrix4X4F skewX = new D2DMatrix4X4F(
            1,
            0,
            0,
            0,
    ...
    public static D2DMatrix4X4F SkewY(float degreeY)
    {
        float angleInRadian = degreeY * (3.141592654f / 180.0f);
        float tanAngle = D2D1Tan(angleInRadian);
        D2DMatrix4X4F skewY = new D2DMatrix4X4F(
            1,
            tanAngle,
            0,
            0,
    ...
    public static D2DMatrix4X4F Translation(float x, float y, float z)
    {
        D2DMatrix4X4F translation = default;
