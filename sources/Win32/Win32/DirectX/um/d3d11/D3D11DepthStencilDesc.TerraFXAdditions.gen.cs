...
{
    public static ref readonly D3D11DepthStencilDesc DEFAULT
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D3D11DepthStencilDesc>());
            return ref Unsafe.As<byte, D3D11DepthStencilDesc>(ref MemoryMarshal.GetReference(data));
        }
    }
