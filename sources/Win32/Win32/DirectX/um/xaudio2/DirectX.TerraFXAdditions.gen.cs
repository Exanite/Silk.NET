...
public static unsafe partial class DirectX
{
    ...
    [DllImport("XAudio2_9", ExactSpelling = true, EntryPoint = "XAudio2Create")]
    ...
    [Transformed]
    [NativeFunction("XAudio2_9", EntryPoint = "XAudio2Create")]
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static HResult XAudio2Create(
        [NativeTypeName("IXAudio2 **")] Ref2D<IXAudio2> ppXAudio2,
        [NativeTypeName("UINT32")] uint Flags = 0,
        [NativeTypeName("XAUDIO2_PROCESSOR")] uint XAudio2Processor = XAUDIO2_DEFAULT_PROCESSOR
    )
    {
