...
{
    public static D2DRectU InfiniteRectU
    {
    ...
    public static D2D1GradientMeshPatch GradientMeshPatch(
    ...
    {
        D2D1GradientMeshPatch newPatch;
    ...
    [SupportedOSPlatform("windows10.0")]
    public static D2D1GradientMeshPatch GradientMeshPatchFromCoonsPatch(
    ...
    public static D2D1InkBezierSegment InkBezierSegment(
    ...
    {
        D2D1InkBezierSegment inkBezierSegment;
    ...
    public static D2D1InkPoint InkPoint(
        [NativeTypeName("const D2D1_POINT_2F &")] in D2DPoint2F point,
        float radius
    )
    {
        D2D1InkPoint inkPoint;
        inkPoint.x = point.x;
        inkPoint.y = point.y;
    ...
    public static D2D1InkStyleProperties InkStyleProperties(
        D2D1_INK_NIB_SHAPE nibShape,
        [NativeTypeName("const D2D1_MATRIX_3X2_F &")] in D2DMatrix3X2F nibTransform
    )
    {
        D2D1InkStyleProperties inkStyleProperties;
        inkStyleProperties.nibShape = nibShape;
        inkStyleProperties.nibTransform = nibTransform;
        return inkStyleProperties;
    }

    public static D2D1SimpleColorProfile SimpleColorProfile(
        [NativeTypeName("const D2D1_POINT_2F &")] in D2DPoint2F redPrimary,
        [NativeTypeName("const D2D1_POINT_2F &")] in D2DPoint2F greenPrimary,
        [NativeTypeName("const D2D1_POINT_2F &")] in D2DPoint2F bluePrimary,
        [NativeTypeName("const D2D1_GAMMA1")] D2D1_GAMMA1 gamma,
        [NativeTypeName("const D2D1_POINT_2F &")] in D2DPoint2F whitePointXZ
    )
    {
        D2D1SimpleColorProfile simpleColorProfile;
