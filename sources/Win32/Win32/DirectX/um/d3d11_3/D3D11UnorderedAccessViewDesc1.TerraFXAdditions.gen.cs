...
public unsafe partial struct D3D11UnorderedAccessViewDesc1
{
    public D3D11_UNORDERED_ACCESS_VIEW_DESC1(
    ...
    )
    {
        ...
        if ((DxgiFormat.FormatUnknown == format) || (unchecked((uint)-1) == wSize))
        {
