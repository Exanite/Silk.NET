...
public unsafe partial struct D3D12Viewport : IEquatable<D3D12Viewport>
{
    ...
    {
        D3D12ResourceDesc Desc = pResource.GetDesc();
    ...
    public static bool operator ==(
        [NativeTypeName("const D3D12_VIEWPORT &")] in D3D12Viewport l,
        [NativeTypeName("const D3D12_VIEWPORT &")] in D3D12Viewport r
    ) =>
    ...
    public override readonly bool Equals([NotNullWhen(true)] object? obj) =>
        (obj is D3D12Viewport other) && Equals(other);

    public readonly bool Equals(D3D12Viewport other) => (this == other);
