...
public unsafe partial struct D3D12HeapDesc : IEquatable<D3D12HeapDesc>
{
    /// <include file='DirectX.xml' path='doc/member[@name="DirectX.Equals"]/*'/>

    public static bool operator ==(
        [NativeTypeName("const D3D12_HEAP_DESC &")] in D3D12HeapDesc l,
        [NativeTypeName("const D3D12_HEAP_DESC &")] in D3D12HeapDesc r
    ) =>
    ...
    public override readonly bool Equals([NotNullWhen(true)] object? obj) =>
        (obj is D3D12HeapDesc other) && Equals(other);

    public readonly bool Equals(D3D12HeapDesc other) => (this == other);
