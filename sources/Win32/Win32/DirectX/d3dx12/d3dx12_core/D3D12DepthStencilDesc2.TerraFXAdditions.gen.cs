...
public unsafe partial struct D3D12DepthStencilDesc2
{
    public D3D12_DEPTH_STENCIL_DESC2(
        [NativeTypeName("const D3D12_DEPTH_STENCIL_DESC1 &")] in D3D12DepthStencilDesc1 o
    )
    {
    ...
    public D3D12_DEPTH_STENCIL_DESC2(
        [NativeTypeName("const D3D12_DEPTH_STENCIL_DESC &")] in D3D12DepthStencilDesc o
    )
    {
        DepthEnable = o.DepthEnable;
        DepthWriteMask = o.DepthWriteMask;
    ...
    public static ref readonly D3D12DepthStencilDesc2 DEFAULT
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D3D12DepthStencilDesc2>());
            return ref Unsafe.As<byte, D3D12DepthStencilDesc2>(
                ref MemoryMarshal.GetReference(data)
            );
        }
    }

    public static explicit operator D3D12DepthStencilDesc(in D3D12DepthStencilDesc2 value) =>
        new D3D12DepthStencilDesc
        {
            ...
            FrontFace = new D3D12DepthStencilopDesc
            {
            ...
            BackFace = new D3D12DepthStencilopDesc
            {
