...
public unsafe partial struct D3D12DepthStencilDesc1
{
    public static ref readonly D3D12DepthStencilDesc1 DEFAULT
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D3D12DepthStencilDesc1>());
            return ref Unsafe.As<byte, D3D12DepthStencilDesc1>(
    ...
    public static explicit operator D3D12DepthStencilDesc(D3D12DepthStencilDesc1 value) =>
