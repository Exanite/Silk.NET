...
{
    public static ref readonly D3D12ViewInstancingDesc DEFAULT
    {
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D3D12ViewInstancingDesc>());
            return ref Unsafe.As<byte, D3D12ViewInstancingDesc>(
