...
public unsafe partial struct D3D12RasterizerDesc1
{
    ...
    public static ref readonly D3D12RasterizerDesc1 DEFAULT
    {
        ...
        get
        {
            ...
            Debug.Assert(data.Length == Unsafe.SizeOf<D3D12RasterizerDesc1>());
            return ref Unsafe.As<byte, D3D12RasterizerDesc1>(ref MemoryMarshal.GetReference(data));
        }
    }

    public static explicit operator D3D12RasterizerDesc(in D3D12RasterizerDesc1 value)
    {
