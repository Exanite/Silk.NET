...
public struct Cd3Dx12PipelineStateStreamMs
{
    [FieldOffset(0)]
    ...
    {
        pssType = D3D12PipelineStateSubobjectType.Ms;
        pssInner = default;
    }
    ...
    public static implicit operator Cd3Dx12PipelineStateStreamMs(in D3D12ShaderBytecode value) =>
        new Cd3Dx12PipelineStateStreamMs(value);

    public static implicit operator D3D12ShaderBytecode(in Cd3Dx12PipelineStateStreamMs value) =>
        value.pssInner;
