...
public struct Cd3Dx12PipelineStateStreamVs
{
    [FieldOffset(0)]
    ...
    {
        pssType = D3D12PipelineStateSubobjectType.Vs;
        pssInner = default;
    }
    ...
    public static implicit operator Cd3Dx12PipelineStateStreamVs(in D3D12ShaderBytecode value) =>
        new Cd3Dx12PipelineStateStreamVs(value);

    public static implicit operator D3D12ShaderBytecode(in Cd3Dx12PipelineStateStreamVs value) =>
        value.pssInner;
