...
public struct Cd3Dx12PipelineStateStreamGs
{
    [FieldOffset(0)]
    ...
    {
        pssType = D3D12PipelineStateSubobjectType.Gs;
        pssInner = default;
    }
    ...
    public static implicit operator Cd3Dx12PipelineStateStreamGs(in D3D12ShaderBytecode value) =>
        new Cd3Dx12PipelineStateStreamGs(value);

    public static implicit operator D3D12ShaderBytecode(in Cd3Dx12PipelineStateStreamGs value) =>
        value.pssInner;
