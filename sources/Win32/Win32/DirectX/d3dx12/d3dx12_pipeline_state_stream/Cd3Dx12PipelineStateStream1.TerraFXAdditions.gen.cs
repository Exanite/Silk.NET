...
public unsafe struct Cd3Dx12PipelineStateStream1
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM1(
    ...
    )
    {
        ...
        DepthStencilState = new D3D12DepthStencilDesc1(Desc.DepthStencilState);
