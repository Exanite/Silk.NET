...
public struct Cd3Dx12PipelineStateStreamDs
{
    [FieldOffset(0)]
    ...
    {
        pssType = D3D12PipelineStateSubobjectType.Ds;
        pssInner = default;
    }
    ...
    public static implicit operator Cd3Dx12PipelineStateStreamDs(in D3D12ShaderBytecode value) =>
        new Cd3Dx12PipelineStateStreamDs(value);

    public static implicit operator D3D12ShaderBytecode(in Cd3Dx12PipelineStateStreamDs value) =>
        value.pssInner;
