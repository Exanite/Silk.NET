...
public unsafe struct Cd3Dx12PipelineStateStream5
{
    ...
    public Cd3Dx12PipelineStateStreamRasterizer2 RasterizerState;
    ...
    )
    {
        ...
        DepthStencilState = new D3D12DepthStencilDesc2(in Desc.DepthStencilState);
        DSVFormat = Desc.DSVFormat;
        RasterizerState = new D3D12RasterizerDesc2(in Desc.RasterizerState);
    ...
    public readonly D3D12GraphicsPipelineStateDesc GraphicsDescV0()
    {
        D3D12GraphicsPipelineStateDesc D = new D3D12GraphicsPipelineStateDesc
        {
            ...
            DSVFormat = DSVFormat,
            RasterizerState = (D3D12RasterizerDesc)(RasterizerState.pssInner),
