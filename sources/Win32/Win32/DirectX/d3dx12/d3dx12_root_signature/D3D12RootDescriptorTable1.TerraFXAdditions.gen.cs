...
public unsafe partial struct D3D12RootDescriptorTable1
{
    public D3D12_ROOT_DESCRIPTOR_TABLE1(
        uint numDescriptorRanges,
        [NativeTypeName("const D3D12_DESCRIPTOR_RANGE1 *")]
            D3D12DescriptorRange1* _pDescriptorRanges
    )
    {
    ...
    public void Init(
        uint numDescriptorRanges,
        [NativeTypeName("const D3D12_DESCRIPTOR_RANGE1 *")]
            Ref<D3D12DescriptorRange1> _pDescriptorRanges
    )
    {
        fixed (D3D12DescriptorRange1* __dsl__pDescriptorRanges = _pDescriptorRanges)
        {
    ...
    public static void Init(
        [NativeTypeName("D3D12_ROOT_DESCRIPTOR_TABLE1 &")]
            ref D3D12RootDescriptorTable1 rootDescriptorTable,
        uint numDescriptorRanges,
        [NativeTypeName("const D3D12_DESCRIPTOR_RANGE1 *")]
            D3D12DescriptorRange1* _pDescriptorRanges
    )
