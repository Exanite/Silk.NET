...
public static unsafe partial class DirectX
{
    ...
    public static bool D3DX12GetCopyableFootprints(
        [NativeTypeName("const D3D12_RESOURCE_DESC1 &")] in D3D12ResourceDesc1 ResourceDesc,
        uint FirstSubresource,
        uint NumSubresources,
        [NativeTypeName("UINT64")] ulong BaseOffset,
        D3D12PlacedSubresourceFootprint* pLayouts,
        uint* pNumRows,
    ...
    )
    {
        ...
        TotalBytes = 0;
        DxgiFormat Format = ResourceDesc.Format;
        Unsafe.SkipInit(out D3D12ResourceDesc1 LresourceDesc);
        ref readonly D3D12ResourceDesc1 resourceDesc = ref D3DX12ConditionallyExpandAPIDesc(
            ref LresourceDesc,
            in ResourceDesc
        );
        // Check if its a valid format
        Debug.Assert(D3D12PropertyLayoutFormatTable.FormatExists(Format));
        uint WidthAlignment = D3D12PropertyLayoutFormatTable.GetWidthAlignment(Format);
        uint HeightAlignment = D3D12PropertyLayoutFormatTable.GetHeightAlignment(Format);
        ushort DepthAlignment = (ushort)(D3D12PropertyLayoutFormatTable.GetDepthAlignment(Format));
        for (; uSubRes < NumSubresources; ++uSubRes)
        {
            ...
            uint subresourceCount =
                ...
                * D3D12PropertyLayoutFormatTable.GetPlaneCount(resourceDesc.Format);
            if (Subresource > subresourceCount)
            {
                break;
            }
            TotalBytes = D3DX12Align<ulong>(TotalBytes, D3D12.TextureDataPlacementAlignment);
            ...
            D3D12PropertyLayoutFormatTable.GetPlaneSubsampledSizeAndFormatForCopyableLayout(
                PlaneSlice,
                Format,
                (uint)(Width),
                Height,
                out DxgiFormat PlaneFormat,
                out uint MinPlanePitchWidth,
                out uint PlaneWidth,
                out uint PlaneHeight
            );
            D3D12SubresourceFootprint LocalPlacement;
            D3D12SubresourceFootprint* Placement =
            ...
            _ = D3D12PropertyLayoutFormatTable.CalculateMinimumRowMajorRowPitch(
                PlaneFormat,
                MinPlanePitchWidth,
                out uint MinPlaneRowPitch
            );
            Debug.Assert(
                (D3D12.TextureDataPlacementAlignment >= D3D12.TextureDataPitchAlignment)
                    && (
                        (D3D12.TextureDataPlacementAlignment % D3D12.TextureDataPitchAlignment) == 0
                    ),
                "D3D12_TEXTURE_DATA_PLACEMENT_ALIGNMENT must be >= and evenly divisible by D3D12_TEXTURE_DATA_PITCH_ALIGNMENT."
            );
            Placement->RowPitch = D3D12PropertyLayoutFormatTable.Planar(Format)
                ? D3DX12Align<uint>(MinPlaneRowPitch, D3D12.TextureDataPlacementAlignment)
                : D3DX12Align<uint>(MinPlaneRowPitch, D3D12.TextureDataPitchAlignment);
            ...
            uint NumRows = 0;
            if (D3D12PropertyLayoutFormatTable.Planar(Format))
            {
                NumRows = PlaneHeight;
            }
            else
        ...
        if (pLayouts != null)
        {
            NativeMemory.Fill(
                pLayouts + uSubRes,
                (nuint)(sizeof(D3D12PlacedSubresourceFootprint)) * (NumSubresources - uSubRes),
                byte.MaxValue
            );
        }
        if (pNumRows != null)
    ...
    public static bool D3DX12GetCopyableFootprints(
        ...
        uint NumSubresources,
        [NativeTypeName("UINT64")] ulong BaseOffset,
        Ref<D3D12PlacedSubresourceFootprint> pLayouts,
        Ref<uint> pNumRows,
    ...
    public static bool D3DX12GetCopyableFootprints(
        [NativeTypeName("const D3D12_RESOURCE_DESC &")] in D3D12ResourceDesc pResourceDesc,
        uint FirstSubresource,
        uint NumSubresources,
        [NativeTypeName("UINT64")] ulong BaseOffset,
        D3D12PlacedSubresourceFootprint* pLayouts,
    ...
    {
        D3D12ResourceDesc1 desc = D3DX12ResourceDesc0ToDesc1(pResourceDesc);
    ...
    public static D3D12ResourceDesc1 D3DX12ResourceDesc0ToDesc1(
        [NativeTypeName("const D3D12_RESOURCE_DESC &")] in D3D12ResourceDesc desc0
    )
    {
        D3D12ResourceDesc1 desc1 = new D3D12ResourceDesc1()
        {
    ...
    {
        D3D12ResourceDesc Desc = pDestinationResource.GetDesc();
    ...
    public static ulong UpdateSubresources(
        ...
        [NativeTypeName("const D3D12_SUBRESOURCE_DATA *")] D3D12SubresourceData* pSrcData
    )
    {
        D3D12ResourceDesc IntermediateDesc = pIntermediate.GetDesc();
        D3D12ResourceDesc DestinationDesc = pDestinationResource.GetDesc();
        if (
            (IntermediateDesc.Dimension != D3D12ResourceDimension.Buffer)
        ...
        else
        {
            for (uint i = 0; i < NumSubresources; ++i)
            {
                D3D12TextureCopyLocation Dst = new D3D12TextureCopyLocation(
                    pDestinationResource,
                    i + FirstSubresource
                );
                D3D12TextureCopyLocation Src = new D3D12TextureCopyLocation(
                    pIntermediate,
                    &pLayouts[i]
                );
    ...
    public static ulong UpdateSubresources(
        ...
        [NativeTypeName("const D3D12_SUBRESOURCE_DATA *")] Ref<D3D12SubresourceData> pSrcData
    )
    {
        fixed (D3D12SubresourceData* __dsl_pSrcData = pSrcData)
    ...
    public static ulong UpdateSubresources(
        ...
        [NativeTypeName("const D3D12_SUBRESOURCE_INFO *")] D3D12SubresourceInfo* pSrcData
    )
    {
        D3D12ResourceDesc IntermediateDesc = pIntermediate.GetDesc();
        D3D12ResourceDesc DestinationDesc = pDestinationResource.GetDesc();
    ...
    public static ulong UpdateSubresources(
        ...
        [NativeTypeName("const D3D12_SUBRESOURCE_INFO *")] Ref<D3D12SubresourceInfo> pSrcData
    )
    {
        fixed (D3D12SubresourceInfo* __dsl_pSrcData = pSrcData)
    ...
    )
    {
        ...
        D3D12PlacedSubresourceFootprint* pLayouts = (D3D12PlacedSubresourceFootprint*)(pMem);
