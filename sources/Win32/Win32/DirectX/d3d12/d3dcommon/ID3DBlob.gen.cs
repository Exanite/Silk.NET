...
public unsafe partial struct ID3DBlob : ID3DBlob.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.ID3D10Blob));
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        {
            return ((delegate* unmanaged<ID3DBlob.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((ID3DBlob.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
    ...
    public static implicit operator ID3DBlob(ID3DBlob.Native* value) => new ID3DBlob((Ptr<Native>)value);
    ...
    /// <param name = "value">The <see cref = "ID3DBlob"/> instance to be converted </param>
    public static implicit operator Ptr<ID3DBlob.Native>(ID3DBlob value) => (Ptr<ID3DBlob.Native>)value.LpVtbl;
    ...
    public static explicit operator ID3DBlob(nuint value) => new ID3DBlob((Ptr<Native>)value.ToPointer());
