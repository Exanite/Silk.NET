...
public unsafe partial struct IDMLDispatchable : IDMLDispatchable.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IDMLDispatchable));

    public interface Interface : IDMLPageable.Interface
    {
        [VtblIndex(8)]
        DmlBindingProperties GetBindingProperties();
    }
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IDMLDispatchable.Native*, uint> )(lpVtbl[1]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        public DmlBindingProperties GetBindingProperties()
        {
            ...
            return *((delegate* unmanaged<IDMLDispatchable.Native*, DmlBindingProperties*, DmlBindingProperties*> )(lpVtbl[8]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLDispatchable.Native*, Guid*, void**, HResult> )(lpVtbl[7]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this), riid, ppv);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLDispatchable.Native*, Guid*, uint*, void*, HResult> )(lpVtbl[3]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this), guid, dataSize, data);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLDispatchable.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IDMLDispatchable.Native*, uint> )(lpVtbl[2]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDMLDispatchable.Native*, ushort*, HResult> )(lpVtbl[6]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this), name);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLDispatchable.Native*, Guid*, uint, void*, HResult> )(lpVtbl[4]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this), guid, dataSize, data);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLDispatchable.Native*, Guid*, IUnknown.Native*, HResult> )(lpVtbl[5]))((IDMLDispatchable.Native*)Unsafe.AsPointer(ref this), guid, data.lpVtbl);
        }
    ...
    public IDMLDispatchable(Ptr3D vtbl) => LpVtbl = (IDMLDispatchable.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "IDMLDispatchable"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDMLDispatchable(Ptr<IDMLDispatchable.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "IDMLDispatchable.Native"/> to <see cref = "IDMLDispatchable"/>.</summary>
    /// <param name = "value">The <see cref = "IDMLDispatchable.Native"/> instance to be converted </param>
    public static implicit operator IDMLDispatchable(IDMLDispatchable.Native* value) => new IDMLDispatchable((Ptr<Native>)value);
    /// <summary>casts <see cref = "IDMLDispatchable"/> to <see cref = "IDMLDispatchable.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "IDMLDispatchable"/> instance to be converted </param>
    public static implicit operator IDMLDispatchable.Native*(IDMLDispatchable value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "IDMLDispatchable"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator IDMLDispatchable(Ptr3D value) => new IDMLDispatchable(value);
    /// <summary>casts <see cref = "IDMLDispatchable"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "IDMLDispatchable"/> instance to be converted </param>
    public static implicit operator Ptr3D(IDMLDispatchable value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "IDMLDispatchable"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator IDMLDispatchable(Ptr<IDMLDispatchable.Native> value) => new IDMLDispatchable(value);
    /// <summary>casts <see cref = "IDMLDispatchable"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "IDMLDispatchable"/> instance to be converted </param>
    public static implicit operator Ptr<IDMLDispatchable.Native>(IDMLDispatchable value) => (Ptr<IDMLDispatchable.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "IDMLDispatchable"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator IDMLDispatchable(void*** value) => new IDMLDispatchable((Ptr<Native>)value);
    /// <summary>casts <see cref = "IDMLDispatchable"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "IDMLDispatchable"/> instance to be converted </param>
    public static implicit operator void***(IDMLDispatchable value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "IDMLDispatchable"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator IDMLDispatchable(nuint value) => new IDMLDispatchable((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "IDMLDispatchable"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "IDMLDispatchable"/> instance to be converted </param>
    public static implicit operator nuint(IDMLDispatchable value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
