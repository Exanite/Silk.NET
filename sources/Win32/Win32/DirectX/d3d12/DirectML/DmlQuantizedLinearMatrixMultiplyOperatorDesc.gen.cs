...
public unsafe partial struct DmlQuantizedLinearMatrixMultiplyOperatorDesc
{
    ...
    [NativeTypeName("const DML_TENSOR_DESC *")]
    public DmlTensorDesc* AScaleTensor;
    ...
    [NativeTypeName("const DML_TENSOR_DESC *")]
    public DmlTensorDesc* AZeroPointTensor;
    ...
    [NativeTypeName("const DML_TENSOR_DESC *")]
    public DmlTensorDesc* BScaleTensor;
    ...
    [NativeTypeName("const DML_TENSOR_DESC *")]
    public DmlTensorDesc* BZeroPointTensor;
