...
public unsafe partial struct IDMLOperator : IDMLOperator.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.IDMLOperator));
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<IDMLOperator.Native*, uint> )(lpVtbl[1]))((IDMLOperator.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDMLOperator.Native*, Guid*, void**, HResult> )(lpVtbl[7]))((IDMLOperator.Native*)Unsafe.AsPointer(ref this), riid, ppv);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLOperator.Native*, Guid*, uint*, void*, HResult> )(lpVtbl[3]))((IDMLOperator.Native*)Unsafe.AsPointer(ref this), guid, dataSize, data);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLOperator.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((IDMLOperator.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<IDMLOperator.Native*, uint> )(lpVtbl[2]))((IDMLOperator.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<IDMLOperator.Native*, ushort*, HResult> )(lpVtbl[6]))((IDMLOperator.Native*)Unsafe.AsPointer(ref this), name);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLOperator.Native*, Guid*, uint, void*, HResult> )(lpVtbl[4]))((IDMLOperator.Native*)Unsafe.AsPointer(ref this), guid, dataSize, data);
        }
        ...
        {
            return ((delegate* unmanaged<IDMLOperator.Native*, Guid*, IUnknown.Native*, HResult> )(lpVtbl[5]))((IDMLOperator.Native*)Unsafe.AsPointer(ref this), guid, data.lpVtbl);
        }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IDMLOperator"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDMLOperator(Ptr3D vtbl) => LpVtbl = (IDMLOperator.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "IDMLOperator"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDMLOperator(Ptr<IDMLOperator.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "IDMLOperator.Native"/> to <see cref = "IDMLOperator"/>.</summary>
    /// <param name = "value">The <see cref = "IDMLOperator.Native"/> instance to be converted </param>
    public static implicit operator IDMLOperator(IDMLOperator.Native* value) => new IDMLOperator((Ptr<Native>)value);
    /// <summary>casts <see cref = "IDMLOperator"/> to <see cref = "IDMLOperator.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "IDMLOperator"/> instance to be converted </param>
    public static implicit operator IDMLOperator.Native*(IDMLOperator value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "IDMLOperator"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator IDMLOperator(Ptr3D value) => new IDMLOperator(value);
    /// <summary>casts <see cref = "IDMLOperator"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "IDMLOperator"/> instance to be converted </param>
    public static implicit operator Ptr3D(IDMLOperator value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "IDMLOperator"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator IDMLOperator(Ptr<IDMLOperator.Native> value) => new IDMLOperator(value);
    /// <summary>casts <see cref = "IDMLOperator"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "IDMLOperator"/> instance to be converted </param>
    public static implicit operator Ptr<IDMLOperator.Native>(IDMLOperator value) => (Ptr<IDMLOperator.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "IDMLOperator"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator IDMLOperator(void*** value) => new IDMLOperator((Ptr<Native>)value);
    /// <summary>casts <see cref = "IDMLOperator"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "IDMLOperator"/> instance to be converted </param>
    public static implicit operator void***(IDMLOperator value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "IDMLOperator"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator IDMLOperator(nuint value) => new IDMLOperator((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "IDMLOperator"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "IDMLOperator"/> instance to be converted </param>
    public static implicit operator nuint(IDMLOperator value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
