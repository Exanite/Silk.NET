...
public unsafe partial struct DmlFillValueSequenceOperatorDesc
{
    ...
    public DmlTensorDataType ValueDataType;
    ...
    public DmlScalarUnion ValueStart;
    ...
    public DmlScalarUnion ValueDelta;
}
