...
public enum D3D12GpuBasedValidationShaderPatchMode
{
    ...
    D3D12GpuBasedValidationShaderPatchModeNone = 0,
    ...
    D3D12GpuBasedValidationShaderPatchModeStateTrackingOnly =
        (D3D12GpuBasedValidationShaderPatchModeNone + 1),
    ...
    D3D12GpuBasedValidationShaderPatchModeUnguardedValidation =
        (D3D12GpuBasedValidationShaderPatchModeStateTrackingOnly + 1),
    ...
    D3D12GpuBasedValidationShaderPatchModeGuardedValidation =
        (D3D12GpuBasedValidationShaderPatchModeUnguardedValidation + 1),
    ...
    NumD3D12GpuBasedValidationShaderPatchModes =
        (D3D12GpuBasedValidationShaderPatchModeGuardedValidation + 1),
}
