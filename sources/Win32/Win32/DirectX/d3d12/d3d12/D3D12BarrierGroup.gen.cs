...
public unsafe partial struct D3D12BarrierGroup
{
    ...
    [UnscopedRef]
    public ref D3D12GlobalBarrier* pGlobalBarriers
    {
    ...
    [UnscopedRef]
    public ref D3D12TextureBarrier* pTextureBarriers
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12BufferBarrier* pBufferBarriers
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public unsafe partial struct _Anonymous_e__Union
    {
        ...
        public D3D12GlobalBarrier* pGlobalBarriers;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pTextureBarriers"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_TEXTURE_BARRIER *")]
        public D3D12TextureBarrier* pTextureBarriers;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pBufferBarriers"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_BUFFER_BARRIER *")]
        public D3D12BufferBarrier* pBufferBarriers;
    }
}
