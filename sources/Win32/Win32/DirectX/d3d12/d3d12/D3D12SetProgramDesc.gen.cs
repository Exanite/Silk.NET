...
public partial struct D3D12SetProgramDesc
{
    ...
    [UnscopedRef]
    public ref D3D12SetGenericPipelineDesc GenericPipeline
    {
    ...
    [UnscopedRef]
    public ref D3D12SetRaytracingPipelineDesc RaytracingPipeline
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12SetWorkGraphDesc WorkGraph
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public partial struct _Anonymous_e__Union
    {
        ...
        [FieldOffset(0)]
        public D3D12SetGenericPipelineDesc GenericPipeline;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.RaytracingPipeline"]/*'/>

        [FieldOffset(0)]
        public D3D12SetRaytracingPipelineDesc RaytracingPipeline;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.WorkGraph"]/*'/>

        [FieldOffset(0)]
        public D3D12SetWorkGraphDesc WorkGraph;
    }
}
