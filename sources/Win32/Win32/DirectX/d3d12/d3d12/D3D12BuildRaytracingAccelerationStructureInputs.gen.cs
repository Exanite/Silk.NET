...
public unsafe partial struct D3D12BuildRaytracingAccelerationStructureInputs
{
    ...
    [UnscopedRef]
    public ref D3D12RaytracingGeometryDesc* pGeometryDescs
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12RaytracingGeometryDesc** ppGeometryDescs
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public unsafe partial struct _Anonymous_e__Union
    {
        ...
        public D3D12RaytracingGeometryDesc* pGeometryDescs;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.ppGeometryDescs"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_RAYTRACING_GEOMETRY_DESC *const *")]
        public D3D12RaytracingGeometryDesc** ppGeometryDescs;
    }
}
