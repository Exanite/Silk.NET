...
public partial struct D3D12FeatureDataD3D12Options14
{
    ...
    [NativeTypeName("BOOL")]
    public MaybeBool<int> AdvancedTextureOpsSupported;
    ...
    [NativeTypeName("BOOL")]
    public MaybeBool<int> WriteableMSAATexturesSupported;
    ...
    [NativeTypeName("BOOL")]
    public MaybeBool<int> IndependentFrontAndBackStencilRefMaskSupported;
}
