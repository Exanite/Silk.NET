...
public unsafe partial struct ID3D12Resource2 : ID3D12Resource2.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.ID3D12Resource2));

    public interface Interface : ID3D12Resource1.Interface
    {
        [VtblIndex(16)]
        D3D12ResourceDesc1 GetDesc1();
    }
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
            ...
            where TSelf : unmanaged, Interface
        {
            ...
            public delegate* unmanaged<TSelf*, D3D12ResourceDesc1*, D3D12ResourceDesc1*> GetDesc1;
        }
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, uint> )(lpVtbl[1]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        public D3D12ResourceDesc GetDesc()
        {
            ...
            return *((delegate* unmanaged<ID3D12Resource2.Native*, D3D12ResourceDesc*, D3D12ResourceDesc*> )(lpVtbl[10]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), &result);
        }

        /// <include file='ID3D12Resource2.xml' path='doc/member[@name="ID3D12Resource2.GetDesc1"]/*'/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [VtblIndex(16)]
        public D3D12ResourceDesc1 GetDesc1()
        {
            D3D12ResourceDesc1 result;
            return *((delegate* unmanaged<ID3D12Resource2.Native*, D3D12ResourceDesc1*, D3D12ResourceDesc1*> )(lpVtbl[16]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, Guid*, void**, HResult> )(lpVtbl[7]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), riid, ppvDevice);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, ulong> )(lpVtbl[11]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, D3D12HeapProperties*, D3D12HeapFlags*, HResult> )(lpVtbl[14]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), pHeapProperties, pHeapFlags);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, Guid*, uint*, void*, HResult> )(lpVtbl[3]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, Guid*, void**, HResult> )(lpVtbl[15]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), riid, ppProtectedSession);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, uint, D3D12Range*, void**, HResult> )(lpVtbl[8]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), Subresource, pReadRange, ppData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, void*, uint, uint, uint, D3D12Box*, HResult> )(lpVtbl[13]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), pDstData, DstRowPitch, DstDepthPitch, SrcSubresource, pSrcBox);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, uint> )(lpVtbl[2]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, ushort*, HResult> )(lpVtbl[6]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), Name);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, Guid*, uint, void*, HResult> )(lpVtbl[4]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, Guid*, IUnknown.Native*, HResult> )(lpVtbl[5]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), guid, pData.lpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Resource2.Native*, uint, D3D12Range*, void> )(lpVtbl[9]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), Subresource, pWrittenRange);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Resource2.Native*, uint, D3D12Box*, void*, uint, uint, HResult> )(lpVtbl[12]))((ID3D12Resource2.Native*)Unsafe.AsPointer(ref this), DstSubresource, pDstBox, pSrcData, SrcRowPitch, SrcDepthPitch);
        }
    ...
    public ID3D12Resource2(Ptr3D vtbl) => LpVtbl = (ID3D12Resource2.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "ID3D12Resource2"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D12Resource2(Ptr<ID3D12Resource2.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "ID3D12Resource2.Native"/> to <see cref = "ID3D12Resource2"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource2.Native"/> instance to be converted </param>
    public static implicit operator ID3D12Resource2(ID3D12Resource2.Native* value) => new ID3D12Resource2((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12Resource2"/> to <see cref = "ID3D12Resource2.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource2"/> instance to be converted </param>
    public static implicit operator ID3D12Resource2.Native*(ID3D12Resource2 value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "ID3D12Resource2"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator ID3D12Resource2(Ptr3D value) => new ID3D12Resource2(value);
    /// <summary>casts <see cref = "ID3D12Resource2"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource2"/> instance to be converted </param>
    public static implicit operator Ptr3D(ID3D12Resource2 value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "ID3D12Resource2"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator ID3D12Resource2(Ptr<ID3D12Resource2.Native> value) => new ID3D12Resource2(value);
    /// <summary>casts <see cref = "ID3D12Resource2"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource2"/> instance to be converted </param>
    public static implicit operator Ptr<ID3D12Resource2.Native>(ID3D12Resource2 value) => (Ptr<ID3D12Resource2.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "ID3D12Resource2"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator ID3D12Resource2(void*** value) => new ID3D12Resource2((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12Resource2"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource2"/> instance to be converted </param>
    public static implicit operator void***(ID3D12Resource2 value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "ID3D12Resource2"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator ID3D12Resource2(nuint value) => new ID3D12Resource2((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "ID3D12Resource2"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource2"/> instance to be converted </param>
    public static implicit operator nuint(ID3D12Resource2 value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(16)]
    public D3D12ResourceDesc1 GetDesc1() => LpVtbl->GetDesc1();
    /// <inheritdoc cref = "ID3D12DeviceChild.GetDevice"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(7)]
