...
public unsafe partial struct ID3D12Device5 : ID3D12Device5.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.ID3D12Device5));

    public interface Interface : ID3D12Device4.Interface
    {
        [VtblIndex(64)]
        D3D12DriverMatchingIdentifierStatus CheckDriverMatchingIdentifier(D3D12SerializedDataType SerializedDataType, [NativeTypeName("const D3D12_SERIALIZED_DATA_DRIVER_MATCHING_IDENTIFIER *")] D3D12SerializedDataDriverMatchingIdentifier* pIdentifierToCheck);
        [VtblIndex(64)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        D3D12DriverMatchingIdentifierStatus CheckDriverMatchingIdentifier(D3D12SerializedDataType SerializedDataType, [NativeTypeName("const D3D12_SERIALIZED_DATA_DRIVER_MATCHING_IDENTIFIER *")] Ref<D3D12SerializedDataDriverMatchingIdentifier> pIdentifierToCheck);
        [VtblIndex(57)]
        HResult CreateLifetimeTracker(ID3D12LifetimeOwner pOwner, [NativeTypeName("const IID &")] Guid* riid, void** ppvTracker);
        [VtblIndex(57)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateLifetimeTracker(ID3D12LifetimeOwner pOwner, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppvTracker);
        [VtblIndex(61)]
        ...
        [VtblIndex(61)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateMetaCommand([NativeTypeName("const GUID &")] Ref<Guid> CommandId, uint NodeMask, [NativeTypeName("const void *")] Ref pCreationParametersData, [NativeTypeName("SIZE_T")] nuint CreationParametersDataSizeInBytes, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppMetaCommand);
        [VtblIndex(62)]
        HResult CreateStateObject([NativeTypeName("const D3D12_STATE_OBJECT_DESC *")] D3D12StateObjectDesc* pDesc, [NativeTypeName("const IID &")] Guid* riid, void** ppStateObject);
        [VtblIndex(62)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateStateObject([NativeTypeName("const D3D12_STATE_OBJECT_DESC *")] Ref<D3D12StateObjectDesc> pDesc, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppStateObject);
        [VtblIndex(60)]
        HResult EnumerateMetaCommandParameters([NativeTypeName("const GUID &")] Guid* CommandId, D3D12MetaCommandParameterStage Stage, uint* pTotalStructureSizeInBytes, uint* pParameterCount, D3D12MetaCommandParameterDesc* pParameterDescs);
        [VtblIndex(60)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult EnumerateMetaCommandParameters([NativeTypeName("const GUID &")] Ref<Guid> CommandId, D3D12MetaCommandParameterStage Stage, Ref<uint> pTotalStructureSizeInBytes, Ref<uint> pParameterCount, Ref<D3D12MetaCommandParameterDesc> pParameterDescs);
        [VtblIndex(59)]
        HResult EnumerateMetaCommands(uint* pNumMetaCommands, D3D12MetaCommandDesc* pDescs);
        [VtblIndex(59)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult EnumerateMetaCommands(Ref<uint> pNumMetaCommands, Ref<D3D12MetaCommandDesc> pDescs);
        [VtblIndex(63)]
        void GetRaytracingAccelerationStructurePrebuildInfo([NativeTypeName("const D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS *")] D3D12BuildRaytracingAccelerationStructureInputs* pDesc, D3D12RaytracingAccelerationStructurePrebuildInfo* pInfo);
        [VtblIndex(63)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        void GetRaytracingAccelerationStructurePrebuildInfo([NativeTypeName("const D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS *")] Ref<D3D12BuildRaytracingAccelerationStructureInputs> pDesc, Ref<D3D12RaytracingAccelerationStructurePrebuildInfo> pInfo);
        [VtblIndex(58)]
        void RemoveDevice();
    }
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint> )(lpVtbl[1]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12SerializedDataType, D3D12SerializedDataDriverMatchingIdentifier*, D3D12DriverMatchingIdentifierStatus> )(lpVtbl[64]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), SerializedDataType, pIdentifierToCheck);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12Feature, void*, uint, HResult> )(lpVtbl[13]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, uint, D3D12CpuDescriptorHandle*, uint*, uint, D3D12CpuDescriptorHandle*, uint*, D3D12DescriptorHeapType, void> )(lpVtbl[23]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), NumDestDescriptorRanges, pDestDescriptorRangeStarts, pDestDescriptorRangeSizes, NumSrcDescriptorRanges, pSrcDescriptorRangeStarts, pSrcDescriptorRangeSizes, DescriptorHeapsType);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, uint, D3D12CpuDescriptorHandle, D3D12CpuDescriptorHandle, D3D12DescriptorHeapType, void> )(lpVtbl[24]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), NumDescriptors, DestDescriptorRangeStart, SrcDescriptorRangeStart, DescriptorHeapsType);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12CommandListType, Guid*, void**, HResult> )(lpVtbl[9]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint, D3D12CommandListType, ID3D12CommandAllocator.Native*, ID3D12PipelineState.Native*, Guid*, void**, HResult> )(lpVtbl[12]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator.LpVtbl, pInitialState.LpVtbl, riid, ppCommandList);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint, D3D12CommandListType, D3D12CommandListFlags, Guid*, void**, HResult> )(lpVtbl[51]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), nodeMask, type, flags, riid, ppCommandList);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12CommandQueueDesc*, Guid*, void**, HResult> )(lpVtbl[8]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppCommandQueue);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12CommandSignatureDesc*, ID3D12RootSignature.Native*, Guid*, void**, HResult> )(lpVtbl[41]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, pRootSignature.LpVtbl, riid, ppvCommandSignature);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12HeapProperties*, D3D12HeapFlags, D3D12ResourceDesc*, D3D12ResourceStates, D3D12ClearValue*, Guid*, void**, HResult> )(lpVtbl[27]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, riidResource, ppvResource);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12HeapProperties*, D3D12HeapFlags, D3D12ResourceDesc*, D3D12ResourceStates, D3D12ClearValue*, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[53]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, pProtectedSession.LpVtbl, riidResource, ppvResource);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12ComputePipelineStateDesc*, Guid*, void**, HResult> )(lpVtbl[11]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, D3D12ConstantBufferViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[17]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12Resource.Native*, D3D12DepthStencilViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[21]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pDesc, DestDescriptor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12DescriptorHeapDesc*, Guid*, void**, HResult> )(lpVtbl[14]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDescriptorHeapDesc, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, ulong, D3D12FenceFlags, Guid*, void**, HResult> )(lpVtbl[36]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12GraphicsPipelineStateDesc*, Guid*, void**, HResult> )(lpVtbl[10]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12HeapDesc*, Guid*, void**, HResult> )(lpVtbl[28]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12HeapDesc*, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[54]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, pProtectedSession.LpVtbl, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12LifetimeOwner.Native*, Guid*, void**, HResult> )(lpVtbl[57]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pOwner.LpVtbl, riid, ppvTracker);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, Guid*, uint, void*, nuint, Guid*, void**, HResult> )(lpVtbl[61]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), CommandId, NodeMask, pCreationParametersData, CreationParametersDataSizeInBytes, riid, ppMetaCommand);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, void*, nuint, Guid*, void**, HResult> )(lpVtbl[44]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pLibraryBlob, BlobLength, riid, ppPipelineLibrary);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12PipelineStateStreamDesc*, Guid*, void**, HResult> )(lpVtbl[47]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12Heap.Native*, ulong, D3D12ResourceDesc*, D3D12ResourceStates, D3D12ClearValue*, Guid*, void**, HResult> )(lpVtbl[29]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pHeap.LpVtbl, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12ProtectedResourceSessionDesc*, Guid*, void**, HResult> )(lpVtbl[52]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppSession);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12QueryHeapDesc*, Guid*, void**, HResult> )(lpVtbl[39]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12Resource.Native*, D3D12RenderTargetViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[20]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pDesc, DestDescriptor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12ResourceDesc*, D3D12ResourceStates, D3D12ClearValue*, Guid*, void**, HResult> )(lpVtbl[30]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12ResourceDesc*, D3D12ResourceStates, D3D12ClearValue*, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[55]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, pProtectedSession.LpVtbl, riid, ppvResource);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint, void*, nuint, Guid*, void**, HResult> )(lpVtbl[16]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), nodeMask, pBlobWithRootSignature, blobLengthInBytes, riid, ppvRootSignature);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, D3D12SamplerDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[22]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12Resource.Native*, D3D12ShaderResourceViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[18]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pDesc, DestDescriptor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12DeviceChild.Native*, SECURITY_ATTRIBUTES*, uint, ushort*, Handle*, HResult> )(lpVtbl[31]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pObject.LpVtbl, pAttributes, Access, Name, pHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12StateObjectDesc*, Guid*, void**, HResult> )(lpVtbl[62]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppStateObject);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12Resource.Native*, ID3D12Resource.Native*, D3D12UnorderedAccessViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[19]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pCounterResource.LpVtbl, pDesc, DestDescriptor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12ResidencyFlags, uint, ID3D12Pageable.Native**, ID3D12Fence.Native*, ulong, HResult> )(lpVtbl[50]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), Flags, NumObjects, &ppObjects->LpVtbl, pFenceToSignal.LpVtbl, FenceValueToSignal);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, Guid*, D3D12MetaCommandParameterStage, uint*, uint*, D3D12MetaCommandParameterDesc*, HResult> )(lpVtbl[60]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), CommandId, Stage, pTotalStructureSizeInBytes, pParameterCount, pParameterDescs);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint*, D3D12MetaCommandDesc*, HResult> )(lpVtbl[59]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pNumMetaCommands, pDescs);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint, ID3D12Pageable.Native**, HResult> )(lpVtbl[35]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), NumObjects, &ppObjects->LpVtbl);
        }
        ...
        {
            LUID result;
            return *((delegate* unmanaged<ID3D12Device5.Native*, LUID*, LUID*> )(lpVtbl[43]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, D3D12ResourceDesc*, uint, uint, ulong, D3D12PlacedSubresourceFootprint*, uint*, ulong*, ulong*, void> )(lpVtbl[38]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pResourceDesc, FirstSubresource, NumSubresources, BaseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
        }
        ...
        public D3D12HeapProperties GetCustomHeapProperties(uint nodeMask, D3D12HeapType heapType)
        {
            ...
            return *((delegate* unmanaged<ID3D12Device5.Native*, D3D12HeapProperties*, uint, D3D12HeapType, D3D12HeapProperties*> )(lpVtbl[26]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), &result, nodeMask, heapType);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, D3D12DescriptorHeapType, uint> )(lpVtbl[15]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), DescriptorHeapType);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, HResult> )(lpVtbl[37]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint> )(lpVtbl[7]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, Guid*, uint*, void*, HResult> )(lpVtbl[3]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, D3D12BuildRaytracingAccelerationStructureInputs*, D3D12RaytracingAccelerationStructurePrebuildInfo*, void> )(lpVtbl[63]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pDesc, pInfo);
        }
        ...
        public D3D12ResourceAllocationInfo GetResourceAllocationInfo(uint visibleMask, uint numResourceDescs, [NativeTypeName("const D3D12_RESOURCE_DESC *")] D3D12ResourceDesc* pResourceDescs)
        {
            ...
            return *((delegate* unmanaged<ID3D12Device5.Native*, D3D12ResourceAllocationInfo*, uint, uint, D3D12ResourceDesc*, D3D12ResourceAllocationInfo*> )(lpVtbl[25]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs);
        }
        ...
        {
            D3D12ResourceAllocationInfo result;
            return *((delegate* unmanaged<ID3D12Device5.Native*, D3D12ResourceAllocationInfo*, uint, uint, D3D12ResourceDesc*, D3D12ResourceAllocationInfo1*, D3D12ResourceAllocationInfo*> )(lpVtbl[56]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs, pResourceAllocationInfo1);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12Resource.Native*, uint*, D3D12PackedMipInfo*, D3D12TileShape*, uint*, uint, D3D12SubresourceTiling*, void> )(lpVtbl[42]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pTiledResource.LpVtbl, pNumTilesForEntireResource, pPackedMipDesc, pStandardTileShapeForNonPackedMips, pNumSubresourceTilings, FirstSubresourceTilingToGet, pSubresourceTilingsForNonPackedMips);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint, ID3D12Pageable.Native**, HResult> )(lpVtbl[34]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), NumObjects, &ppObjects->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, void*, Guid*, void**, HResult> )(lpVtbl[48]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), pAddress, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, Handle, Guid*, void**, HResult> )(lpVtbl[49]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), hFileMapping, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, Handle, Guid*, void**, HResult> )(lpVtbl[32]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), NTHandle, riid, ppvObj);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, ushort*, uint, Handle*, HResult> )(lpVtbl[33]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint> )(lpVtbl[2]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device5.Native*, void> )(lpVtbl[58]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, ID3D12Fence.Native**, ulong*, uint, D3D12MultipleFenceWaitFlags, Handle, HResult> )(lpVtbl[45]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), &ppFences->LpVtbl, pFenceValues, NumFences, Flags, hEvent);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, ushort*, HResult> )(lpVtbl[6]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), Name);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, Guid*, uint, void*, HResult> )(lpVtbl[4]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, Guid*, IUnknown.Native*, HResult> )(lpVtbl[5]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), guid, pData.lpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, uint, ID3D12Pageable.Native**, D3D12ResidencyPriority*, HResult> )(lpVtbl[46]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), NumObjects, &ppObjects->LpVtbl, pPriorities);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device5.Native*, MaybeBool<int>, HResult> )(lpVtbl[40]))((ID3D12Device5.Native*)Unsafe.AsPointer(ref this), Enable);
        }
    }
    ...
    public ID3D12Device5(Ptr3D vtbl) => LpVtbl = (ID3D12Device5.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "ID3D12Device5"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D12Device5(Ptr<ID3D12Device5.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "ID3D12Device5.Native"/> to <see cref = "ID3D12Device5"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Device5.Native"/> instance to be converted </param>
    public static implicit operator ID3D12Device5(ID3D12Device5.Native* value) => new ID3D12Device5((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12Device5"/> to <see cref = "ID3D12Device5.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12Device5"/> instance to be converted </param>
    public static implicit operator ID3D12Device5.Native*(ID3D12Device5 value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "ID3D12Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator ID3D12Device5(Ptr3D value) => new ID3D12Device5(value);
    /// <summary>casts <see cref = "ID3D12Device5"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Device5"/> instance to be converted </param>
    public static implicit operator Ptr3D(ID3D12Device5 value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "ID3D12Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator ID3D12Device5(Ptr<ID3D12Device5.Native> value) => new ID3D12Device5(value);
    /// <summary>casts <see cref = "ID3D12Device5"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Device5"/> instance to be converted </param>
    public static implicit operator Ptr<ID3D12Device5.Native>(ID3D12Device5 value) => (Ptr<ID3D12Device5.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "ID3D12Device5"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator ID3D12Device5(void*** value) => new ID3D12Device5((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12Device5"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12Device5"/> instance to be converted </param>
    public static implicit operator void***(ID3D12Device5 value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "ID3D12Device5"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator ID3D12Device5(nuint value) => new ID3D12Device5((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "ID3D12Device5"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Device5"/> instance to be converted </param>
    public static implicit operator nuint(ID3D12Device5 value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
