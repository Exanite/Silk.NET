...
public unsafe partial struct ID3D12GraphicsCommandList1 : ID3D12GraphicsCommandList1.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.ID3D12GraphicsCommandList1));

    public interface Interface : ID3D12GraphicsCommandList.Interface
    {
        [VtblIndex(60)]
        void AtomicCopyBufferUINT(ID3D12Resource pDstBuffer, [NativeTypeName("UINT64")] ulong DstOffset, ID3D12Resource pSrcBuffer, [NativeTypeName("UINT64")] ulong SrcOffset, uint Dependencies, [NativeTypeName("ID3D12Resource *const *")] ID3D12Resource* ppDependentResources, [NativeTypeName("const D3D12_SUBRESOURCE_RANGE_UINT64 *")] D3D12SubresourceRangeUint64* pDependentSubresourceRanges);
        [VtblIndex(60)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        void AtomicCopyBufferUINT(ID3D12Resource pDstBuffer, [NativeTypeName("UINT64")] ulong DstOffset, ID3D12Resource pSrcBuffer, [NativeTypeName("UINT64")] ulong SrcOffset, uint Dependencies, [NativeTypeName("ID3D12Resource *const *")] Ref<ID3D12Resource> ppDependentResources, [NativeTypeName("const D3D12_SUBRESOURCE_RANGE_UINT64 *")] Ref<D3D12SubresourceRangeUint64> pDependentSubresourceRanges);
        [VtblIndex(61)]
        ...
        [VtblIndex(64)]
        void ResolveSubresourceRegion(ID3D12Resource pDstResource, uint DstSubresource, uint DstX, uint DstY, ID3D12Resource pSrcResource, uint SrcSubresource, [NativeTypeName("D3D12_RECT *")] RECT* pSrcRect, DxgiFormat Format, D3D12ResolveMode ResolveMode);
        [VtblIndex(64)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        void ResolveSubresourceRegion(ID3D12Resource pDstResource, uint DstSubresource, uint DstX, uint DstY, ID3D12Resource pSrcResource, uint SrcSubresource, [NativeTypeName("D3D12_RECT *")] Ref<RECT> pSrcRect, DxgiFormat Format, D3D12ResolveMode ResolveMode);
        [VtblIndex(63)]
        void SetSamplePositions(uint NumSamplesPerPixel, uint NumPixels, D3D12SamplePosition* pSamplePositions);
        [VtblIndex(63)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        void SetSamplePositions(uint NumSamplesPerPixel, uint NumPixels, Ref<D3D12SamplePosition> pSamplePositions);
        [VtblIndex(65)]
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint> )(lpVtbl[1]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, ulong, ID3D12Resource.Native*, ulong, uint, ID3D12Resource.Native**, D3D12SubresourceRangeUint64*, void> )(lpVtbl[60]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pDstBuffer.LpVtbl, DstOffset, pSrcBuffer.LpVtbl, SrcOffset, Dependencies, &ppDependentResources->LpVtbl, pDependentSubresourceRanges);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, ulong, ID3D12Resource.Native*, ulong, uint, ID3D12Resource.Native**, D3D12SubresourceRangeUint64*, void> )(lpVtbl[61]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pDstBuffer.LpVtbl, DstOffset, pSrcBuffer.LpVtbl, SrcOffset, Dependencies, &ppDependentResources->LpVtbl, pDependentSubresourceRanges);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, void*, uint, void> )(lpVtbl[57]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12QueryHeap.Native*, D3D12QueryType, uint, void> )(lpVtbl[52]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pQueryHeap.LpVtbl, Type, Index);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, D3D12CpuDescriptorHandle, D3D12ClearFlags, float, byte, uint, RECT*, void> )(lpVtbl[47]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), DepthStencilView, ClearFlags, Depth, Stencil, NumRects, pRects);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, D3D12CpuDescriptorHandle, float*, uint, RECT*, void> )(lpVtbl[48]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RenderTargetView, ColorRGBA, NumRects, pRects);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12PipelineState.Native*, void> )(lpVtbl[11]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pPipelineState.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, D3D12GpuDescriptorHandle, D3D12CpuDescriptorHandle, ID3D12Resource.Native*, float*, uint, RECT*, void> )(lpVtbl[50]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), ViewGPUHandleInCurrentHeap, ViewCPUHandle, pResource.LpVtbl, Values, NumRects, pRects);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, D3D12GpuDescriptorHandle, D3D12CpuDescriptorHandle, ID3D12Resource.Native*, uint*, uint, RECT*, void> )(lpVtbl[49]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), ViewGPUHandleInCurrentHeap, ViewCPUHandle, pResource.LpVtbl, Values, NumRects, pRects);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, HResult> )(lpVtbl[9]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, ulong, ID3D12Resource.Native*, ulong, ulong, void> )(lpVtbl[15]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pDstBuffer.LpVtbl, DstOffset, pSrcBuffer.LpVtbl, SrcOffset, NumBytes);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, ID3D12Resource.Native*, void> )(lpVtbl[17]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pDstResource.LpVtbl, pSrcResource.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, D3D12TextureCopyLocation*, uint, uint, uint, D3D12TextureCopyLocation*, D3D12Box*, void> )(lpVtbl[16]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pDst, DstX, DstY, DstZ, pSrc, pSrcBox);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, D3D12TiledResourceCoordinate*, D3D12TileRegionSize*, ID3D12Resource.Native*, ulong, D3D12TileCopyFlags, void> )(lpVtbl[18]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pTiledResource.LpVtbl, pTileRegionStartCoordinate, pTileRegionSize, pBuffer.LpVtbl, BufferStartOffsetInBytes, Flags);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, D3D12DiscardRegion*, void> )(lpVtbl[51]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pRegion);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, uint, void> )(lpVtbl[14]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), ThreadGroupCountX, ThreadGroupCountY, ThreadGroupCountZ);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, uint, int, uint, void> )(lpVtbl[13]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), IndexCountPerInstance, InstanceCount, StartIndexLocation, BaseVertexLocation, StartInstanceLocation);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, uint, uint, void> )(lpVtbl[12]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), VertexCountPerInstance, InstanceCount, StartVertexLocation, StartInstanceLocation);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, void> )(lpVtbl[58]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12QueryHeap.Native*, D3D12QueryType, uint, void> )(lpVtbl[53]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pQueryHeap.LpVtbl, Type, Index);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12GraphicsCommandList.Native*, void> )(lpVtbl[27]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pCommandList.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12CommandSignature.Native*, uint, ID3D12Resource.Native*, ulong, ID3D12Resource.Native*, ulong, void> )(lpVtbl[59]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pCommandSignature.LpVtbl, MaxCommandCount, pArgumentBuffer.LpVtbl, ArgumentBufferOffset, pCountBuffer.LpVtbl, CountBufferOffset);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, Guid*, void**, HResult> )(lpVtbl[7]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), riid, ppvDevice);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, Guid*, uint*, void*, HResult> )(lpVtbl[3]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, D3D12CommandListType> )(lpVtbl[8]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, D3D12IndexBufferView*, void> )(lpVtbl[43]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pView);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, D3DPrimitiveTopology, void> )(lpVtbl[20]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), PrimitiveTopology);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, D3D12VertexBufferView*, void> )(lpVtbl[44]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), StartSlot, NumViews, pViews);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, float*, void> )(lpVtbl[23]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), BlendFactor);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, float, float, void> )(lpVtbl[62]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), Min, Max);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, D3D12CpuDescriptorHandle*, MaybeBool<int>, D3D12CpuDescriptorHandle*, void> )(lpVtbl[46]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), NumRenderTargetDescriptors, pRenderTargetDescriptors, RTsSingleHandleToDescriptorRange, pDepthStencilDescriptor);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, void> )(lpVtbl[24]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), StencilRef);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint> )(lpVtbl[2]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12CommandAllocator.Native*, ID3D12PipelineState.Native*, HResult> )(lpVtbl[10]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pAllocator.LpVtbl, pInitialState.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12QueryHeap.Native*, D3D12QueryType, uint, uint, ID3D12Resource.Native*, ulong, void> )(lpVtbl[54]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pQueryHeap.LpVtbl, Type, StartIndex, NumQueries, pDestinationBuffer.LpVtbl, AlignedDestinationBufferOffset);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, uint, ID3D12Resource.Native*, uint, DxgiFormat, void> )(lpVtbl[19]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pDstResource.LpVtbl, DstSubresource, pSrcResource.LpVtbl, SrcSubresource, Format);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, uint, uint, uint, ID3D12Resource.Native*, uint, RECT*, DxgiFormat, D3D12ResolveMode, void> )(lpVtbl[64]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pDstResource.LpVtbl, DstSubresource, DstX, DstY, pSrcResource.LpVtbl, SrcSubresource, pSrcRect, Format, ResolveMode);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, D3D12ResourceBarrier*, void> )(lpVtbl[26]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), NumBarriers, pBarriers);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, RECT*, void> )(lpVtbl[22]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), NumRects, pRects);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, D3D12Viewport*, void> )(lpVtbl[21]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), NumViewports, pViewports);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, uint, void> )(lpVtbl[33]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, SrcData, DestOffsetIn32BitValues);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, void*, uint, void> )(lpVtbl[35]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, Num32BitValuesToSet, pSrcData, DestOffsetIn32BitValues);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, ulong, void> )(lpVtbl[37]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, D3D12GpuDescriptorHandle, void> )(lpVtbl[31]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, BaseDescriptor);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, ulong, void> )(lpVtbl[39]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12RootSignature.Native*, void> )(lpVtbl[29]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pRootSignature.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, ulong, void> )(lpVtbl[41]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, ID3D12DescriptorHeap.Native**, void> )(lpVtbl[28]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), NumDescriptorHeaps, &ppDescriptorHeaps->LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, uint, void> )(lpVtbl[34]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, SrcData, DestOffsetIn32BitValues);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, void*, uint, void> )(lpVtbl[36]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, Num32BitValuesToSet, pSrcData, DestOffsetIn32BitValues);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, ulong, void> )(lpVtbl[38]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, D3D12GpuDescriptorHandle, void> )(lpVtbl[32]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, BaseDescriptor);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, ulong, void> )(lpVtbl[40]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12RootSignature.Native*, void> )(lpVtbl[30]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pRootSignature.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, ulong, void> )(lpVtbl[42]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), RootParameterIndex, BufferLocation);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, void*, uint, void> )(lpVtbl[56]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ushort*, HResult> )(lpVtbl[6]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), Name);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12PipelineState.Native*, void> )(lpVtbl[25]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pPipelineState.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, ID3D12Resource.Native*, ulong, D3D12PredicationOp, void> )(lpVtbl[55]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), pBuffer.LpVtbl, AlignedBufferOffset, Operation);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, Guid*, uint, void*, HResult> )(lpVtbl[4]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, Guid*, IUnknown.Native*, HResult> )(lpVtbl[5]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), guid, pData.lpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, D3D12SamplePosition*, void> )(lpVtbl[63]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), NumSamplesPerPixel, NumPixels, pSamplePositions);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, void> )(lpVtbl[65]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), Mask);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12GraphicsCommandList1.Native*, uint, uint, D3D12StreamOutputBufferView*, void> )(lpVtbl[45]))((ID3D12GraphicsCommandList1.Native*)Unsafe.AsPointer(ref this), StartSlot, NumViews, pViews);
        }
    ...
    public ID3D12GraphicsCommandList1(Ptr3D vtbl) => LpVtbl = (ID3D12GraphicsCommandList1.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "ID3D12GraphicsCommandList1"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D12GraphicsCommandList1(Ptr<ID3D12GraphicsCommandList1.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "ID3D12GraphicsCommandList1.Native"/> to <see cref = "ID3D12GraphicsCommandList1"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12GraphicsCommandList1.Native"/> instance to be converted </param>
    public static implicit operator ID3D12GraphicsCommandList1(ID3D12GraphicsCommandList1.Native* value) => new ID3D12GraphicsCommandList1((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12GraphicsCommandList1"/> to <see cref = "ID3D12GraphicsCommandList1.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12GraphicsCommandList1"/> instance to be converted </param>
    public static implicit operator ID3D12GraphicsCommandList1.Native*(ID3D12GraphicsCommandList1 value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "ID3D12GraphicsCommandList1"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator ID3D12GraphicsCommandList1(Ptr3D value) => new ID3D12GraphicsCommandList1(value);
    /// <summary>casts <see cref = "ID3D12GraphicsCommandList1"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12GraphicsCommandList1"/> instance to be converted </param>
    public static implicit operator Ptr3D(ID3D12GraphicsCommandList1 value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "ID3D12GraphicsCommandList1"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator ID3D12GraphicsCommandList1(Ptr<ID3D12GraphicsCommandList1.Native> value) => new ID3D12GraphicsCommandList1(value);
    /// <summary>casts <see cref = "ID3D12GraphicsCommandList1"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12GraphicsCommandList1"/> instance to be converted </param>
    public static implicit operator Ptr<ID3D12GraphicsCommandList1.Native>(ID3D12GraphicsCommandList1 value) => (Ptr<ID3D12GraphicsCommandList1.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "ID3D12GraphicsCommandList1"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator ID3D12GraphicsCommandList1(void*** value) => new ID3D12GraphicsCommandList1((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12GraphicsCommandList1"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12GraphicsCommandList1"/> instance to be converted </param>
    public static implicit operator void***(ID3D12GraphicsCommandList1 value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "ID3D12GraphicsCommandList1"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator ID3D12GraphicsCommandList1(nuint value) => new ID3D12GraphicsCommandList1((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "ID3D12GraphicsCommandList1"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12GraphicsCommandList1"/> instance to be converted </param>
    public static implicit operator nuint(ID3D12GraphicsCommandList1 value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
