...
public unsafe partial struct ID3D12Device3 : ID3D12Device3.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.ID3D12Device3));

    public interface Interface : ID3D12Device2.Interface
    {
        [VtblIndex(50)]
        HResult EnqueueMakeResident(D3D12ResidencyFlags Flags, uint NumObjects, [NativeTypeName("ID3D12Pageable *const *")] ID3D12Pageable* ppObjects, ID3D12Fence pFenceToSignal, [NativeTypeName("UINT64")] ulong FenceValueToSignal);
        [VtblIndex(50)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult EnqueueMakeResident(D3D12ResidencyFlags Flags, uint NumObjects, [NativeTypeName("ID3D12Pageable *const *")] Ref<ID3D12Pageable> ppObjects, ID3D12Fence pFenceToSignal, [NativeTypeName("UINT64")] ulong FenceValueToSignal);
        [VtblIndex(48)]
        ...
        [VtblIndex(48)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult OpenExistingHeapFromAddress([NativeTypeName("const void *")] Ref pAddress, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppvHeap);
        [VtblIndex(49)]
        HResult OpenExistingHeapFromFileMapping(Handle hFileMapping, [NativeTypeName("const IID &")] Guid* riid, void** ppvHeap);
        [VtblIndex(49)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult OpenExistingHeapFromFileMapping(Handle hFileMapping, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppvHeap);
    }
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, uint> )(lpVtbl[1]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12Feature, void*, uint, HResult> )(lpVtbl[13]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, uint, D3D12CpuDescriptorHandle*, uint*, uint, D3D12CpuDescriptorHandle*, uint*, D3D12DescriptorHeapType, void> )(lpVtbl[23]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), NumDestDescriptorRanges, pDestDescriptorRangeStarts, pDestDescriptorRangeSizes, NumSrcDescriptorRanges, pSrcDescriptorRangeStarts, pSrcDescriptorRangeSizes, DescriptorHeapsType);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, uint, D3D12CpuDescriptorHandle, D3D12CpuDescriptorHandle, D3D12DescriptorHeapType, void> )(lpVtbl[24]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), NumDescriptors, DestDescriptorRangeStart, SrcDescriptorRangeStart, DescriptorHeapsType);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12CommandListType, Guid*, void**, HResult> )(lpVtbl[9]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, uint, D3D12CommandListType, ID3D12CommandAllocator.Native*, ID3D12PipelineState.Native*, Guid*, void**, HResult> )(lpVtbl[12]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator.LpVtbl, pInitialState.LpVtbl, riid, ppCommandList);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12CommandQueueDesc*, Guid*, void**, HResult> )(lpVtbl[8]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppCommandQueue);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12CommandSignatureDesc*, ID3D12RootSignature.Native*, Guid*, void**, HResult> )(lpVtbl[41]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, pRootSignature.LpVtbl, riid, ppvCommandSignature);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12HeapProperties*, D3D12HeapFlags, D3D12ResourceDesc*, D3D12ResourceStates, D3D12ClearValue*, Guid*, void**, HResult> )(lpVtbl[27]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, riidResource, ppvResource);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12ComputePipelineStateDesc*, Guid*, void**, HResult> )(lpVtbl[11]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, D3D12ConstantBufferViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[17]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, ID3D12Resource.Native*, D3D12DepthStencilViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[21]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pDesc, DestDescriptor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12DescriptorHeapDesc*, Guid*, void**, HResult> )(lpVtbl[14]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDescriptorHeapDesc, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, ulong, D3D12FenceFlags, Guid*, void**, HResult> )(lpVtbl[36]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12GraphicsPipelineStateDesc*, Guid*, void**, HResult> )(lpVtbl[10]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12HeapDesc*, Guid*, void**, HResult> )(lpVtbl[28]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, void*, nuint, Guid*, void**, HResult> )(lpVtbl[44]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pLibraryBlob, BlobLength, riid, ppPipelineLibrary);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12PipelineStateStreamDesc*, Guid*, void**, HResult> )(lpVtbl[47]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, ID3D12Heap.Native*, ulong, D3D12ResourceDesc*, D3D12ResourceStates, D3D12ClearValue*, Guid*, void**, HResult> )(lpVtbl[29]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pHeap.LpVtbl, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12QueryHeapDesc*, Guid*, void**, HResult> )(lpVtbl[39]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, ID3D12Resource.Native*, D3D12RenderTargetViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[20]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pDesc, DestDescriptor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12ResourceDesc*, D3D12ResourceStates, D3D12ClearValue*, Guid*, void**, HResult> )(lpVtbl[30]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, uint, void*, nuint, Guid*, void**, HResult> )(lpVtbl[16]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), nodeMask, pBlobWithRootSignature, blobLengthInBytes, riid, ppvRootSignature);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, D3D12SamplerDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[22]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, ID3D12Resource.Native*, D3D12ShaderResourceViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[18]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pDesc, DestDescriptor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, ID3D12DeviceChild.Native*, SECURITY_ATTRIBUTES*, uint, ushort*, Handle*, HResult> )(lpVtbl[31]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pObject.LpVtbl, pAttributes, Access, Name, pHandle);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, ID3D12Resource.Native*, ID3D12Resource.Native*, D3D12UnorderedAccessViewDesc*, D3D12CpuDescriptorHandle, void> )(lpVtbl[19]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pCounterResource.LpVtbl, pDesc, DestDescriptor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12ResidencyFlags, uint, ID3D12Pageable.Native**, ID3D12Fence.Native*, ulong, HResult> )(lpVtbl[50]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), Flags, NumObjects, &ppObjects->LpVtbl, pFenceToSignal.LpVtbl, FenceValueToSignal);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, uint, ID3D12Pageable.Native**, HResult> )(lpVtbl[35]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), NumObjects, &ppObjects->LpVtbl);
        }
        ...
        {
            LUID result;
            return *((delegate* unmanaged<ID3D12Device3.Native*, LUID*, LUID*> )(lpVtbl[43]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), &result);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, D3D12ResourceDesc*, uint, uint, ulong, D3D12PlacedSubresourceFootprint*, uint*, ulong*, ulong*, void> )(lpVtbl[38]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pResourceDesc, FirstSubresource, NumSubresources, BaseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
        }
        ...
        public D3D12HeapProperties GetCustomHeapProperties(uint nodeMask, D3D12HeapType heapType)
        {
            ...
            return *((delegate* unmanaged<ID3D12Device3.Native*, D3D12HeapProperties*, uint, D3D12HeapType, D3D12HeapProperties*> )(lpVtbl[26]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), &result, nodeMask, heapType);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, D3D12DescriptorHeapType, uint> )(lpVtbl[15]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), DescriptorHeapType);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, HResult> )(lpVtbl[37]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, uint> )(lpVtbl[7]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, Guid*, uint*, void*, HResult> )(lpVtbl[3]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
        }
        ...
        public D3D12ResourceAllocationInfo GetResourceAllocationInfo(uint visibleMask, uint numResourceDescs, [NativeTypeName("const D3D12_RESOURCE_DESC *")] D3D12ResourceDesc* pResourceDescs)
        {
            ...
            return *((delegate* unmanaged<ID3D12Device3.Native*, D3D12ResourceAllocationInfo*, uint, uint, D3D12ResourceDesc*, D3D12ResourceAllocationInfo*> )(lpVtbl[25]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12Device3.Native*, ID3D12Resource.Native*, uint*, D3D12PackedMipInfo*, D3D12TileShape*, uint*, uint, D3D12SubresourceTiling*, void> )(lpVtbl[42]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pTiledResource.LpVtbl, pNumTilesForEntireResource, pPackedMipDesc, pStandardTileShapeForNonPackedMips, pNumSubresourceTilings, FirstSubresourceTilingToGet, pSubresourceTilingsForNonPackedMips);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, uint, ID3D12Pageable.Native**, HResult> )(lpVtbl[34]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), NumObjects, &ppObjects->LpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, void*, Guid*, void**, HResult> )(lpVtbl[48]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), pAddress, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, Handle, Guid*, void**, HResult> )(lpVtbl[49]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), hFileMapping, riid, ppvHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, Handle, Guid*, void**, HResult> )(lpVtbl[32]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), NTHandle, riid, ppvObj);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, ushort*, uint, Handle*, HResult> )(lpVtbl[33]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, uint> )(lpVtbl[2]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, ID3D12Fence.Native**, ulong*, uint, D3D12MultipleFenceWaitFlags, Handle, HResult> )(lpVtbl[45]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), &ppFences->LpVtbl, pFenceValues, NumFences, Flags, hEvent);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, ushort*, HResult> )(lpVtbl[6]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), Name);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, Guid*, uint, void*, HResult> )(lpVtbl[4]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, Guid*, IUnknown.Native*, HResult> )(lpVtbl[5]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), guid, pData.lpVtbl);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, uint, ID3D12Pageable.Native**, D3D12ResidencyPriority*, HResult> )(lpVtbl[46]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), NumObjects, &ppObjects->LpVtbl, pPriorities);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12Device3.Native*, MaybeBool<int>, HResult> )(lpVtbl[40]))((ID3D12Device3.Native*)Unsafe.AsPointer(ref this), Enable);
        }
    }
    ...
    public ID3D12Device3(Ptr3D vtbl) => LpVtbl = (ID3D12Device3.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "ID3D12Device3"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D12Device3(Ptr<ID3D12Device3.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "ID3D12Device3.Native"/> to <see cref = "ID3D12Device3"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Device3.Native"/> instance to be converted </param>
    public static implicit operator ID3D12Device3(ID3D12Device3.Native* value) => new ID3D12Device3((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12Device3"/> to <see cref = "ID3D12Device3.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12Device3"/> instance to be converted </param>
    public static implicit operator ID3D12Device3.Native*(ID3D12Device3 value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "ID3D12Device3"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator ID3D12Device3(Ptr3D value) => new ID3D12Device3(value);
    /// <summary>casts <see cref = "ID3D12Device3"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Device3"/> instance to be converted </param>
    public static implicit operator Ptr3D(ID3D12Device3 value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "ID3D12Device3"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator ID3D12Device3(Ptr<ID3D12Device3.Native> value) => new ID3D12Device3(value);
    /// <summary>casts <see cref = "ID3D12Device3"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Device3"/> instance to be converted </param>
    public static implicit operator Ptr<ID3D12Device3.Native>(ID3D12Device3 value) => (Ptr<ID3D12Device3.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "ID3D12Device3"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator ID3D12Device3(void*** value) => new ID3D12Device3((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12Device3"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12Device3"/> instance to be converted </param>
    public static implicit operator void***(ID3D12Device3 value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "ID3D12Device3"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator ID3D12Device3(nuint value) => new ID3D12Device3((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "ID3D12Device3"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12Device3"/> instance to be converted </param>
    public static implicit operator nuint(ID3D12Device3 value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
