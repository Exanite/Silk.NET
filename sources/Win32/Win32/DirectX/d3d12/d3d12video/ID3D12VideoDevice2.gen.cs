...
public unsafe partial struct ID3D12VideoDevice2 : ID3D12VideoDevice2.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.ID3D12VideoDevice2));

    public interface Interface : ID3D12VideoDevice1.Interface
    {
        [VtblIndex(9)]
        HResult CreateVideoDecoder1([NativeTypeName("const D3D12_VIDEO_DECODER_DESC *")] D3D12VideoDecoderDesc* pDesc, ID3D12ProtectedResourceSession pProtectedResourceSession, [NativeTypeName("const IID &")] Guid* riid, void** ppVideoDecoder);
        [VtblIndex(9)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateVideoDecoder1([NativeTypeName("const D3D12_VIDEO_DECODER_DESC *")] Ref<D3D12VideoDecoderDesc> pDesc, ID3D12ProtectedResourceSession pProtectedResourceSession, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppVideoDecoder);
        [VtblIndex(10)]
        HResult CreateVideoDecoderHeap1([NativeTypeName("const D3D12_VIDEO_DECODER_HEAP_DESC *")] D3D12VideoDecoderHeapDesc* pVideoDecoderHeapDesc, ID3D12ProtectedResourceSession pProtectedResourceSession, [NativeTypeName("const IID &")] Guid* riid, void** ppVideoDecoderHeap);
        [VtblIndex(10)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateVideoDecoderHeap1([NativeTypeName("const D3D12_VIDEO_DECODER_HEAP_DESC *")] Ref<D3D12VideoDecoderHeapDesc> pVideoDecoderHeapDesc, ID3D12ProtectedResourceSession pProtectedResourceSession, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppVideoDecoderHeap);
        [VtblIndex(12)]
        HResult CreateVideoExtensionCommand([NativeTypeName("const D3D12_VIDEO_EXTENSION_COMMAND_DESC *")] D3D12VideoExtensionCommandDesc* pDesc, [NativeTypeName("const void *")] void* pCreationParameters, [NativeTypeName("SIZE_T")] nuint CreationParametersDataSizeInBytes, ID3D12ProtectedResourceSession pProtectedResourceSession, [NativeTypeName("const IID &")] Guid* riid, void** ppVideoExtensionCommand);
        [VtblIndex(12)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult CreateVideoExtensionCommand([NativeTypeName("const D3D12_VIDEO_EXTENSION_COMMAND_DESC *")] Ref<D3D12VideoExtensionCommandDesc> pDesc, [NativeTypeName("const void *")] Ref pCreationParameters, [NativeTypeName("SIZE_T")] nuint CreationParametersDataSizeInBytes, ID3D12ProtectedResourceSession pProtectedResourceSession, [NativeTypeName("const IID &")] Ref<Guid> riid, Ref2D ppVideoExtensionCommand);
        [VtblIndex(11)]
        ...
        [VtblIndex(13)]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        HResult ExecuteExtensionCommand(ID3D12VideoExtensionCommand pExtensionCommand, [NativeTypeName("const void *")] Ref pExecutionParameters, [NativeTypeName("SIZE_T")] nuint ExecutionParametersSizeInBytes, Ref pOutputData, [NativeTypeName("SIZE_T")] nuint OutputDataSizeInBytes);
    }
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, uint> )(lpVtbl[1]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, D3D12FeatureVideo, void*, uint, HResult> )(lpVtbl[3]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), FeatureVideo, pFeatureSupportData, FeatureSupportDataSize);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, D3D12VideoDecoderDesc*, Guid*, void**, HResult> )(lpVtbl[4]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), pDesc, riid, ppVideoDecoder);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, D3D12VideoDecoderDesc*, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[9]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), pDesc, pProtectedResourceSession.LpVtbl, riid, ppVideoDecoder);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, D3D12VideoDecoderHeapDesc*, Guid*, void**, HResult> )(lpVtbl[5]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), pVideoDecoderHeapDesc, riid, ppVideoDecoderHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, D3D12VideoDecoderHeapDesc*, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[10]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), pVideoDecoderHeapDesc, pProtectedResourceSession.LpVtbl, riid, ppVideoDecoderHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, D3D12VideoExtensionCommandDesc*, void*, nuint, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[12]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), pDesc, pCreationParameters, CreationParametersDataSizeInBytes, pProtectedResourceSession.LpVtbl, riid, ppVideoExtensionCommand);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, D3D12VideoMotionEstimatorDesc*, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[7]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), pDesc, pProtectedResourceSession.LpVtbl, riid, ppVideoMotionEstimator);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, D3D12VideoMotionVectorHeapDesc*, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[8]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), pDesc, pProtectedResourceSession.LpVtbl, riid, ppVideoMotionVectorHeap);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, uint, D3D12VideoProcessOutputStreamDesc*, uint, D3D12VideoProcessInputStreamDesc*, Guid*, void**, HResult> )(lpVtbl[6]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), NodeMask, pOutputStreamDesc, NumInputStreamDescs, pInputStreamDescs, riid, ppVideoProcessor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, uint, D3D12VideoProcessOutputStreamDesc*, uint, D3D12VideoProcessInputStreamDesc*, ID3D12ProtectedResourceSession.Native*, Guid*, void**, HResult> )(lpVtbl[11]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), NodeMask, pOutputStreamDesc, NumInputStreamDescs, pInputStreamDescs, pProtectedResourceSession.LpVtbl, riid, ppVideoProcessor);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, ID3D12VideoExtensionCommand.Native*, void*, nuint, void*, nuint, HResult> )(lpVtbl[13]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), pExtensionCommand.LpVtbl, pExecutionParameters, ExecutionParametersSizeInBytes, pOutputData, OutputDataSizeInBytes);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<ID3D12VideoDevice2.Native*, uint> )(lpVtbl[2]))((ID3D12VideoDevice2.Native*)Unsafe.AsPointer(ref this));
        }
    }
    ...
    public ID3D12VideoDevice2(Ptr3D vtbl) => LpVtbl = (ID3D12VideoDevice2.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "ID3D12VideoDevice2"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D12VideoDevice2(Ptr<ID3D12VideoDevice2.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "ID3D12VideoDevice2.Native"/> to <see cref = "ID3D12VideoDevice2"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDevice2.Native"/> instance to be converted </param>
    public static implicit operator ID3D12VideoDevice2(ID3D12VideoDevice2.Native* value) => new ID3D12VideoDevice2((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12VideoDevice2"/> to <see cref = "ID3D12VideoDevice2.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDevice2"/> instance to be converted </param>
    public static implicit operator ID3D12VideoDevice2.Native*(ID3D12VideoDevice2 value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "ID3D12VideoDevice2"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator ID3D12VideoDevice2(Ptr3D value) => new ID3D12VideoDevice2(value);
    /// <summary>casts <see cref = "ID3D12VideoDevice2"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDevice2"/> instance to be converted </param>
    public static implicit operator Ptr3D(ID3D12VideoDevice2 value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "ID3D12VideoDevice2"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator ID3D12VideoDevice2(Ptr<ID3D12VideoDevice2.Native> value) => new ID3D12VideoDevice2(value);
    /// <summary>casts <see cref = "ID3D12VideoDevice2"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDevice2"/> instance to be converted </param>
    public static implicit operator Ptr<ID3D12VideoDevice2.Native>(ID3D12VideoDevice2 value) => (Ptr<ID3D12VideoDevice2.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "ID3D12VideoDevice2"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator ID3D12VideoDevice2(void*** value) => new ID3D12VideoDevice2((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12VideoDevice2"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDevice2"/> instance to be converted </param>
    public static implicit operator void***(ID3D12VideoDevice2 value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "ID3D12VideoDevice2"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator ID3D12VideoDevice2(nuint value) => new ID3D12VideoDevice2((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "ID3D12VideoDevice2"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDevice2"/> instance to be converted </param>
    public static implicit operator nuint(ID3D12VideoDevice2 value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
