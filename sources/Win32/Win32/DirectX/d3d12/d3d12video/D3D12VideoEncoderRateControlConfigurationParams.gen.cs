...
public unsafe partial struct D3D12VideoEncoderRateControlConfigurationParams
{
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlCqp* pConfiguration_CQP
    {
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlCbr* pConfiguration_CBR
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlVbr* pConfiguration_VBR
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlQvbr* pConfiguration_QVBR
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlCqp1* pConfiguration_CQP1
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlCbr1* pConfiguration_CBR1
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlVbr1* pConfiguration_VBR1
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlQvbr1* pConfiguration_QVBR1
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderRateControlAbsoluteQpMap* pConfiguration_AbsoluteQPMap
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public unsafe partial struct _Anonymous_e__Union
    {
        ...
        public D3D12VideoEncoderRateControlCqp* pConfiguration_CQP;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pConfiguration_CBR"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_VIDEO_ENCODER_RATE_CONTROL_CBR *")]
        public D3D12VideoEncoderRateControlCbr* pConfiguration_CBR;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pConfiguration_VBR"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_VIDEO_ENCODER_RATE_CONTROL_VBR *")]
        public D3D12VideoEncoderRateControlVbr* pConfiguration_VBR;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pConfiguration_QVBR"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_VIDEO_ENCODER_RATE_CONTROL_QVBR *")]
        public D3D12VideoEncoderRateControlQvbr* pConfiguration_QVBR;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pConfiguration_CQP1"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_VIDEO_ENCODER_RATE_CONTROL_CQP1 *")]
        public D3D12VideoEncoderRateControlCqp1* pConfiguration_CQP1;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pConfiguration_CBR1"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_VIDEO_ENCODER_RATE_CONTROL_CBR1 *")]
        public D3D12VideoEncoderRateControlCbr1* pConfiguration_CBR1;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pConfiguration_VBR1"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_VIDEO_ENCODER_RATE_CONTROL_VBR1 *")]
        public D3D12VideoEncoderRateControlVbr1* pConfiguration_VBR1;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pConfiguration_QVBR1"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_VIDEO_ENCODER_RATE_CONTROL_QVBR1 *")]
        public D3D12VideoEncoderRateControlQvbr1* pConfiguration_QVBR1;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pConfiguration_AbsoluteQPMap"]/*'/>

        [FieldOffset(0)]
        [NativeTypeName("const D3D12_VIDEO_ENCODER_RATE_CONTROL_ABSOLUTE_QP_MAP *")]
        public D3D12VideoEncoderRateControlAbsoluteQpMap* pConfiguration_AbsoluteQPMap;
    }
}
