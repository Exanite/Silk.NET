...
public unsafe partial struct D3D12VideoEncoderCodecConfiguration
{
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderCodecConfigurationH264* pH264Config
    {
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderCodecConfigurationHevc* pHEVCConfig
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [UnscopedRef]
    public ref D3D12VideoEncoderAv1CodecConfiguration* pAV1Config
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public unsafe partial struct _Anonymous_e__Union
    {
        ...
        [FieldOffset(0)]
        public D3D12VideoEncoderCodecConfigurationH264* pH264Config;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pHEVCConfig"]/*'/>

        [FieldOffset(0)]
        public D3D12VideoEncoderCodecConfigurationHevc* pHEVCConfig;

        /// <include file='_Anonymous_e__Union.xml' path='doc/member[@name="_Anonymous_e__Union.pAV1Config"]/*'/>

        [FieldOffset(0)]
        public D3D12VideoEncoderAv1CodecConfiguration* pAV1Config;
    }
}
