...
public unsafe partial struct ID3D12VideoDecodeCommandList3 : ID3D12VideoDecodeCommandList3.Interface, INativeGuid
{
    ...
    static Guid* INativeGuid.NativeGuid => (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID.ID3D12VideoDecodeCommandList3));
    ...
    public unsafe partial struct Native : Interface, INativeGuid
    {
        ...
        public uint AddRef()
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, uint> )(lpVtbl[1]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, uint, D3D12BarrierGroup*, void> )(lpVtbl[27]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), NumBarrierGroups, pBarrierGroups);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, uint, void*, uint, void> )(lpVtbl[19]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12QueryHeap.Native*, D3D12QueryType, uint, void> )(lpVtbl[14]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pQueryHeap.LpVtbl, Type, Index);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, void> )(lpVtbl[11]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, HResult> )(lpVtbl[9]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12VideoDecoder.Native*, D3D12VideoDecodeOutputStreamArguments*, D3D12VideoDecodeInputStreamArguments*, void> )(lpVtbl[21]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pDecoder.LpVtbl, pOutputArguments, pInputArguments);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12VideoDecoder.Native*, D3D12VideoDecodeOutputStreamArguments1*, D3D12VideoDecodeInputStreamArguments*, void> )(lpVtbl[23]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pDecoder.LpVtbl, pOutputArguments, pInputArguments);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12Resource.Native*, D3D12DiscardRegion*, void> )(lpVtbl[13]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pResource.LpVtbl, pRegion);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, void> )(lpVtbl[20]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12QueryHeap.Native*, D3D12QueryType, uint, void> )(lpVtbl[15]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pQueryHeap.LpVtbl, Type, Index);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12VideoExtensionCommand.Native*, void*, nuint, void> )(lpVtbl[26]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pExtensionCommand.LpVtbl, pExecutionParameters, ExecutionParametersSizeInBytes);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, Guid*, void**, HResult> )(lpVtbl[7]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), riid, ppvDevice);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, Guid*, uint*, void*, HResult> )(lpVtbl[3]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, D3D12CommandListType> )(lpVtbl[8]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12VideoExtensionCommand.Native*, void*, nuint, void> )(lpVtbl[25]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pExtensionCommand.LpVtbl, pInitializationParameters, InitializationParametersSizeInBytes);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, Guid*, void**, HResult> )(lpVtbl[0]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), riid, ppvObject);
        }
        ...
        public uint Release()
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, uint> )(lpVtbl[2]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12CommandAllocator.Native*, HResult> )(lpVtbl[10]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pAllocator.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12QueryHeap.Native*, D3D12QueryType, uint, uint, ID3D12Resource.Native*, ulong, void> )(lpVtbl[16]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pQueryHeap.LpVtbl, Type, StartIndex, NumQueries, pDestinationBuffer.LpVtbl, AlignedDestinationBufferOffset);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, uint, D3D12ResourceBarrier*, void> )(lpVtbl[12]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), NumBarriers, pBarriers);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, uint, void*, uint, void> )(lpVtbl[18]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), Metadata, pData, Size);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ushort*, HResult> )(lpVtbl[6]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), Name);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12Resource.Native*, ulong, D3D12PredicationOp, void> )(lpVtbl[17]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pBuffer.LpVtbl, AlignedBufferOffset, Operation);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, Guid*, uint, void*, HResult> )(lpVtbl[4]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
        }
        ...
        {
            return ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, Guid*, IUnknown.Native*, HResult> )(lpVtbl[5]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), guid, pData.lpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, ID3D12ProtectedResourceSession.Native*, void> )(lpVtbl[24]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), pProtectedResourceSession.LpVtbl);
        }
        ...
        {
            ((delegate* unmanaged<ID3D12VideoDecodeCommandList3.Native*, uint, D3D12WritebufferimmediateParameter*, D3D12WritebufferimmediateMode*, void> )(lpVtbl[22]))((ID3D12VideoDecodeCommandList3.Native*)Unsafe.AsPointer(ref this), Count, pParams, pModes);
        }
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID3D12VideoDecodeCommandList3"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D12VideoDecodeCommandList3(Ptr3D vtbl) => LpVtbl = (ID3D12VideoDecodeCommandList3.Native*)vtbl;
    /// <summary>Initializes a new instance of the <see cref = "ID3D12VideoDecodeCommandList3"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D12VideoDecodeCommandList3(Ptr<ID3D12VideoDecodeCommandList3.Native> vtbl) => LpVtbl = vtbl;
    /// <summary>casts <see cref = "ID3D12VideoDecodeCommandList3.Native"/> to <see cref = "ID3D12VideoDecodeCommandList3"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDecodeCommandList3.Native"/> instance to be converted </param>
    public static implicit operator ID3D12VideoDecodeCommandList3(ID3D12VideoDecodeCommandList3.Native* value) => new ID3D12VideoDecodeCommandList3((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12VideoDecodeCommandList3"/> to <see cref = "ID3D12VideoDecodeCommandList3.Native"/> pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDecodeCommandList3"/> instance to be converted </param>
    public static implicit operator ID3D12VideoDecodeCommandList3.Native*(ID3D12VideoDecodeCommandList3 value) => value.LpVtbl;
    /// <summary>casts <see cref = "Ptr3D"/> to <see cref = "ID3D12VideoDecodeCommandList3"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr3D"/> instance to be converted </param>
    public static explicit operator ID3D12VideoDecodeCommandList3(Ptr3D value) => new ID3D12VideoDecodeCommandList3(value);
    /// <summary>casts <see cref = "ID3D12VideoDecodeCommandList3"/> to <see cref = "Ptr3D"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDecodeCommandList3"/> instance to be converted </param>
    public static implicit operator Ptr3D(ID3D12VideoDecodeCommandList3 value) => (Ptr3D)value.LpVtbl;
    /// <summary>casts <see cref = "Ptr{T}"/> to <see cref = "ID3D12VideoDecodeCommandList3"/>.</summary>
    /// <param name = "value">The <see cref = "Ptr{T}"/> instance to be converted </param>
    public static explicit operator ID3D12VideoDecodeCommandList3(Ptr<ID3D12VideoDecodeCommandList3.Native> value) => new ID3D12VideoDecodeCommandList3(value);
    /// <summary>casts <see cref = "ID3D12VideoDecodeCommandList3"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDecodeCommandList3"/> instance to be converted </param>
    public static implicit operator Ptr<ID3D12VideoDecodeCommandList3.Native>(ID3D12VideoDecodeCommandList3 value) => (Ptr<ID3D12VideoDecodeCommandList3.Native>)value.LpVtbl;
    /// <summary>casts void*** to <see cref = "ID3D12VideoDecodeCommandList3"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator ID3D12VideoDecodeCommandList3(void*** value) => new ID3D12VideoDecodeCommandList3((Ptr<Native>)value);
    /// <summary>casts <see cref = "ID3D12VideoDecodeCommandList3"/> to void*** pointer.</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDecodeCommandList3"/> instance to be converted </param>
    public static implicit operator void***(ID3D12VideoDecodeCommandList3 value) => (void***)value.LpVtbl;
    /// <summary>casts <see cref = "nuint"/> to <see cref = "ID3D12VideoDecodeCommandList3"/>.</summary>
    /// <param name = "value">The <see cref = "nuint"/> instance to be converted </param>
    public static explicit operator ID3D12VideoDecodeCommandList3(nuint value) => new ID3D12VideoDecodeCommandList3((Ptr<Native>)value.ToPointer());
    /// <summary>casts <see cref = "ID3D12VideoDecodeCommandList3"/> to <see cref = "nuint"/> .</summary>
    /// <param name = "value">The <see cref = "ID3D12VideoDecodeCommandList3"/> instance to be converted </param>
    public static implicit operator nuint(ID3D12VideoDecodeCommandList3 value) => (nuint)value.LpVtbl;
    /// <inheritdoc cref = "IUnknown.AddRef"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    [return: NativeTypeName("ULONG")]
