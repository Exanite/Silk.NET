...
public static partial class D3D11
{
    ...
    public const int SbResourceFlagsMask = (0x00010000 | 0x00020000 | 0x00800000);

    [NativeTypeName("#define D3D11_SB_UAV_HAS_ORDER_PRESERVING_COUNTER 0x00800000")]
    public const int SbUavHasOrderPreservingCounter = 0x00800000;

    [NativeTypeName("#define D3D11_SB_UAV_FLAGS_MASK 0x00800000")]
    public const int SbUavFlagsMask = 0x00800000;
}
