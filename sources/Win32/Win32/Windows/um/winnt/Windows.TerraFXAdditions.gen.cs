...
{
    public static int MemoryAllocationAlignment
    {
        get
        {
            if (sizeof(nint) == 4)
    ...
    public static int MaximumProcPerGroup
    {
        get
        {
            if (sizeof(nint) == 4)
    ...
    public static int MaximumProcessors => MaximumProcPerGroup;
    ...
    public static Handle MemoryCurrentPartitionHandle => unchecked((Handle)((nint)(-1)));

    [NativeTypeName("#define MEMORY_SYSTEM_PARTITION_HANDLE ((HANDLE) (LONG_PTR) -2)")]
    public static Handle MemorySystemPartitionHandle => unchecked((Handle)((nint)(-2)));

    [NativeTypeName("#define MEMORY_EXISTING_VAD_PARTITION_HANDLE ((HANDLE) (LONG_PTR) -3)")]
    public static Handle MemoryExistingVadPartitionHandle => unchecked((Handle)((nint)(-3)));
}
