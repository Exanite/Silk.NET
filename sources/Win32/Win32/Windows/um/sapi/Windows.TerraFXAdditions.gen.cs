...
public static unsafe partial class Windows
{
    ...
    public static SPSTATEHANDLE SpruletransTextbuffer => (SPSTATEHANDLE)(-1);

    [NativeTypeName("#define SPRULETRANS_WILDCARD (SPSTATEHANDLE)(-2)")]
    public static SPSTATEHANDLE SpruletransWildcard => (SPSTATEHANDLE)(-2);

    [NativeTypeName("#define SPRULETRANS_DICTATION (SPSTATEHANDLE)(-3)")]
    public static SPSTATEHANDLE SpruletransDictation => (SPSTATEHANDLE)(-3);
