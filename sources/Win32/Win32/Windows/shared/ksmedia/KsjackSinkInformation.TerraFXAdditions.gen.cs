...
public unsafe partial struct KsjackSinkInformation
{
    public KsjackSinkConnectiontype ConnType;
    ...
    public MaybeBool<int> HDCPCapable;
    public MaybeBool<int> AICapable;
