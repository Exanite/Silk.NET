...
public unsafe partial interface IAL
{
    ...
    [return: NativeTypeName("ALboolean")]
    [NativeFunction("openal", EntryPoint = "alIsEffectDirect")]
    sbyte IsEffectDirectRawDirect(ContextHandle context, [NativeTypeName("ALuint")] uint effect);
    ...
    [return: NativeTypeName("ALboolean")]
    [NativeFunction("openal", EntryPoint = "alIsFilterDirect")]
    sbyte IsFilterDirectRawDirect(ContextHandle context, [NativeTypeName("ALuint")] uint filter);
    ...
    [return: NativeTypeName("ALboolean")]
    [NativeFunction("openal", EntryPoint = "alIsSourceDirect")]
    sbyte IsSourceDirectRawDirect(ContextHandle context, [NativeTypeName("ALuint")] uint source);
