...
namespace Silk.NET.Slang
{
    ...
    public unsafe partial struct ISlangClonable : IComVtbl<ISlangClonable>, IComVtbl<ISlangCastable>, IComVtbl<ISlangUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe void* Clone([Flow(Silk.NET.Core.Native.FlowDirection.In)] SlangUUID* guid)
        {
            var @this = (ISlangClonable*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            void* ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe void* Clone([Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SlangUUID guid)
        {
            var @this = (ISlangClonable*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            void* ret = default;
            fixed (SlangUUID* guidPtr = &guid)
