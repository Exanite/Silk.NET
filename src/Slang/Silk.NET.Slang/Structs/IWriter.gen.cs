...
namespace Silk.NET.Slang
{
    ...
    public unsafe partial struct IWriter : IComVtbl<IWriter>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator Silk.NET.Core.Native.IUnknown(IWriter val)
            => Unsafe.As<IWriter, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (IWriter*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
