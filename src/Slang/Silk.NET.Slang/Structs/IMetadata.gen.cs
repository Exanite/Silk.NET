...
namespace Silk.NET.Slang
{
    ...
    public unsafe partial struct IMetadata : IComVtbl<IMetadata>, IComVtbl<ISlangCastable>, IComVtbl<ISlangUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int IsParameterLocationUsed(SlangParameterCategory category, ulong spaceIndex, ulong registerIndex, bool* outUsed)
        {
            var @this = (IMetadata*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int IsParameterLocationUsed(SlangParameterCategory category, ulong spaceIndex, ulong registerIndex, ref bool outUsed)
        {
            var @this = (IMetadata*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
