...
namespace Silk.NET.Slang
{
    ...
    public unsafe partial struct IEntryPoint : IComVtbl<IEntryPoint>, IComVtbl<IComponentType>, IComVtbl<ISlangUnknown>
    {
        ...
        public static implicit operator ISlangUnknown(IEntryPoint val)
            => Unsafe.As<IEntryPoint, ISlangUnknown>(ref val);
