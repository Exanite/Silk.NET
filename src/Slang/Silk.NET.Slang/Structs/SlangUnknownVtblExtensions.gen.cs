...
public unsafe static class SlangUnknownVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<ISlangUnknown> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SlangUUID uuid, void** outObject)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<ISlangUnknown> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SlangUUID uuid, ref void* outObject)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (SlangUUID* uuidPtr = &uuid)
    ...
    /// <summary>To be documented.</summary>
    public static uint AddRef(this ComPtr<ISlangUnknown> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        uint ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static uint Release(this ComPtr<ISlangUnknown> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        uint ret = default;
