...
public unsafe static class TypeConformanceVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetEntryPointHostCallable(this ComPtr<ITypeConformance> thisVtbl, int entryPointIndex, int targetIndex, ISlangSharedLibrary** outSharedLibrary, IBlob** outDiagnostics)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetEntryPointHostCallable(this ComPtr<ITypeConformance> thisVtbl, int entryPointIndex, int targetIndex, ISlangSharedLibrary** outSharedLibrary, ref IBlob* outDiagnostics)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetEntryPointHostCallable(this ComPtr<ITypeConformance> thisVtbl, int entryPointIndex, int targetIndex, ref ISlangSharedLibrary* outSharedLibrary, IBlob** outDiagnostics)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetEntryPointHostCallable(this ComPtr<ITypeConformance> thisVtbl, int entryPointIndex, int targetIndex, ref ISlangSharedLibrary* outSharedLibrary, ref IBlob* outDiagnostics)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (ISlangSharedLibrary** outSharedLibraryPtr = &outSharedLibrary)
