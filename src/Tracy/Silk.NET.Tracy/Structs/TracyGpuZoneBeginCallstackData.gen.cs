...
{
    [NativeName("Name", "___tracy_gpu_zone_begin_callstack_data")]
    public unsafe partial struct TracyGpuZoneBeginCallstackData
    {
        public TracyGpuZoneBeginCallstackData
        (
            ulong? srcloc = null,
            int? depth = null,
            ushort? queryId = null,
