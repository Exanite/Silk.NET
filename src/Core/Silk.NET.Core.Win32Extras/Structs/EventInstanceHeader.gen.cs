...
namespace Silk.NET.Core.Win32Extras
{
    ...
    public unsafe partial struct EventInstanceHeader
    {
        ...
        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L962_C5")]
        [NativeName("Name", "anonymous1")]
        public EventInstanceHeaderUnion1 Anonymous1;

        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L969_C5")]
        ...
        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L983_C5")]
