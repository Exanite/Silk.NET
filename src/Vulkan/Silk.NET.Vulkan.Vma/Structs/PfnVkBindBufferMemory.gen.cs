...
namespace Silk.NET.Vulkan.Vma
{
    ...
    public delegate Silk.NET.Vulkan.Result VkBindBufferMemory(Silk.NET.Vulkan.Device arg0, Silk.NET.Vulkan.Buffer arg1, Silk.NET.Vulkan.DeviceMemory arg2, ulong arg3);
}
